...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_7ba5bd90_hasScoped_false_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__(28);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
  __webpack_require__(25)
...
var _mine = __webpack_require__(38);
...
exports.default = {
    ...
    methods: _extends({
        ...
        goSinger: function goSinger(singername) {
            this.$router.push({ name: 'singer', params: { singername: singername } });
        },
        goSongtype: function goSongtype(type, imgsrc) {
            this.$router.push({ name: 'singtype', params: { type: type }, query: { imgsrc: imgsrc } });
        }
    }, (0, _vuex.mapActions)(['getAllsongs'])),
    created: function created() {
        this.getAllsongs({ url: 'http://39.97.167.207:1811/vue/allsongs' });
    },

    computed: _extends({}, (0, _vuex.mapState)(['allsongs'])),
    data: function data() {
        return {
            selected: "1",
            imgs: [{ he: "http://39.97.167.207/vueimg/1.jpg" }, { he: "http://39.97.167.207/vueimg/2.jpg" }, { he: "http://39.97.167.207/vueimg/3.jpg" }],
            imgs2: [{ name: "张杰", pic: "http://39.97.167.207/vueimg/zhangjie.jpg" }, { name: "周杰伦", pic: "http://39.97.167.207/vueimg/zhoujielun.jpg" }, { name: "赵雷", pic: "http://39.97.167.207/vueimg/zhaolei.jpg" }],
            imgs3: [{ name: "风吹草动 动人心弦", pic: "http://39.97.167.207/vueimg/gedan1.jpg", songtype: "唯美" }, { name: "优美动听民谣", pic: "http://39.97.167.207/vueimg/gedan2.jpg", songtype: "民族" }, { name: "潸然泪下情歌", pic: "http://39.97.167.207/vueimg/gedan3.jpg", songtype: "爱情" }, { name: "流行嗨歌", pic: "http://39.97.167.207/vueimg/gedan4.jpg", songtype: "流行" }]
        };
    }
};
...
exports.default = {
    data: function data() {
        return {
            imgs: "http://39.97.167.207/vueimg/gedan4.jpg",
            ico: "&#xe6fe;",
            songs: []
        };
    },
    ...
    methods: {
        gosong: function gosong(id) {
            this.$router.push({ name: "songlrc", params: { songId: id } });
        }
    },
    computed: {},
    mounted: function mounted() {},
    created: function created() {
        ...
        this.$http.get("http://39.97.167.207:1811/vue/order").then(function (res) {
            _this.songs = res.data.result;
        });
    }
}; //
//
...
exports.default = {
    data: function data() {
        return {
            ...
            pic: 'http://39.97.167.207/vueimg/head.jpg',
            pic1: 'http://39.97.167.207/vueimg/nologin.jpg',
            icons: [{ msg: "音乐", icon: "&#xe609;" }, { msg: "我的收藏", icon: "&#xe60a;" }, { msg: "最近播放", icon: "&#xe607;" }],
            flag: false
        };
    },
...
exports.default = {
	data: function data() {
		return {
			...
			show: true,
			autop: 1,
			// playimg:require('/images/details_play.png'),
			// playimg2:require('/images/details_pause.png'),
			ico: "&#xe607;",
			ico2: "&#xe60c;"
		};
	},
	...
	watch: {
		sclca: function sclca(val) {
			this.$refs.kuan.style.width = val;
			this.$refs.lefts.style.left = val;
		},
		ctimes: function ctimes(oldval) {
			for (var i = 0; i < this.geshitime.length; i++) {
				var stops = -this.$refs.one[i].clientHeight;
				if (i != this.geshitime.length - 1 && oldval > this.geshitime[i] * 1 && oldval < this.geshitime[i + 1] * 1) {
					this.$refs.one[i].className = "active";
					if (i > 4) {
						if (stops == 0) {
							stops = -this.$refs.one[i - 1].clientHeight;
							i = i--;
							this.$refs.scrollul.style.WebkitTransform = "translate3d(0," + stops * (i - 4) + "px,0)";
						} else {
							this.$refs.scrollul.style.WebkitTransform = "translate3d(0," + stops * (i - 4) + "px,0)";
						}
						// this.$refs.scrollul.style.WebkitTransform = "translate3d(0,"+this.stops*i+"px,0)"
					} else {
						this.$refs.scrollul.style.WebkitTransform = "translate3d(0,0,0)";
					}
				} else {
					this.$refs.one[i].className = "";
				}
			}
		}
	},
	methods: _extends({}, (0, _vuex.mapActions)(['getAllsongs']), {
		updadteTime: function updadteTime() {
			var min = this.$refs.playmusic.currentTime / 60 | 0;
			var sec = this.$refs.playmusic.currentTime % 60 | 0;
			min = min >= 10 ? min : "0" + min;
			sec = sec >= 10 ? sec : "0" + sec;
			var alltimer = min + ":" + sec;
			this.ctimes = this.$refs.playmusic.currentTime.toFixed(2);
			this.time.ctime = alltimer;
		},
		allTime: function allTime() {
			var min = this.$refs.playmusic.duration / 60 | 0;
			var sec = this.$refs.playmusic.duration % 60 | 0;
			min = min >= 10 ? min : "0" + min;
			sec = sec >= 10 ? sec : "0" + sec;
			var alltimer = min + ":" + sec;
			this.time.ttimes = this.$refs.playmusic.duration;
			this.time.ttime = alltimer;
		},
		ended: function ended() {
			//播放结束 自动切换下一首
			var songid = this.onesong[0].songId;
			if (songid == this.allsongs.length) {
				songid = 1;
				this.$router.push({ name: "songlrc", params: { songId: songid } });
		...
		prevSong: function prevSong(id) {
			if (id == 1) {
				id = this.allsongs.length;
				this.$router.push({ name: "songlrc", params: { songId: id } });
				window.location.reload();
			} else {
				id--;
		...
		nextSong: function nextSong(id) {
			if (id == this.allsongs.length) {
				id = 1;
				this.$router.push({ name: "songlrc", params: { songId: id } });
				window.location.reload();
			} else {
		...
		mylove: function mylove() {
			if (localStorage.username) {
				var num = this.onesong[0].hotnum;
				num++;
				this.$http.get("http://39.97.167.207:1811/vue/hotcount", { params: { musicid: this.onesong[0].songId, countnum: num } }).then(function (res) {});
			} else {
				this.$router.push({ name: "login" });
			}
		},
		pinglun: function pinglun(names, songname, id) {
			if (localStorage.username) {
				this.$router.push({ name: "opinion", params: { singer: names }, query: { songer: songname, sid: id } });
			} else {
				this.$router.push({ name: "login" });
			}
		}
	}),
	computed: _extends({}, (0, _vuex.mapState)(['allsongs']), (0, _vuex.mapGetters)(['onesong']), {
		songlrc: function songlrc() {
			var geci = [];
			var re = /\[[^[]+/g;
			var lrc = this.onesong[0].lyric.match(re);
			for (var i = 0; i < lrc.length; i++) {
				var onelrc = lrc[i];
				geci.push(onelrc.split("]")[1]);
			}
			return geci;
		},
		sclca: function sclca() {
			//就算百分比
			var bfb = (this.ctimes / this.time.ttimes * 100).toFixed(2) + "%";
			return bfb;
		},
		suiyi: function suiyi() {
			var geci = [];
			var re = /\[[^[]+/g;
			var lrc = this.onesong[0].lyric.match(re);
			for (var i = 0; i < lrc.length; i++) {
				lrc[i] = [lrc[i].substring(0, 10).substring(1, 9), lrc[i].substring(10)];
				geci.push(lrc[i]);
			}
			return geci;
		},
		geshitime: function geshitime() {
			var st = [];
			for (var i = 0; i < this.suiyi.length; i++) {
				var onest = this.suiyi[i][0].split(":")[0] * 60 + this.suiyi[i][0].split(":")[1] * 1;
				st.push(onest.toFixed(2));
			}
			return st;
		}
	...
	updated: function updated() {},
	mounted: function mounted() {
		// this.onesong =  this.allsongs.filter((item,index)=>item.songId==this.$route.params.songId);
		this.$store.dispatch('getSong', this.$route.params.songId);

		// setTimeout(()=>{
		// 	var myAudio = this.$refs.playmusic;
		// 	console.log(myAudio)
		// 	myAudio.addEventListener("ended",()=>{
		// 		console.log(66);
		// 		let songid = this.onesong[0].songId;
		// 		songid++;
		// 		this.$router.push({name:"songlrc",params:{songId:songid}})
		// 		window.location.reload();
	...
	created: function created() {
		// this.$http.get("http://39.97.167.207:1810/vue/onesong",{params:{id:this.onesongId}}).then(res=>{
		//     this.onesong = res.data.result;
...
exports.default = {
    data: function data() {
        return {
            ico: "&#xe626;",
            imgs: "http://39.97.167.207/vueimg/300.jpg"
        };
    },
    ...
    computed: _extends({}, (0, _vuex.mapState)(['allsongs'])),
    created: function created() {
        // this.$http.get("http://39.97.167.207:1810/vue/allsongs").then(res=>{
        //     this.allsongs = res.data.result;
        // })
    }
};
...
exports.default = {
    ...
    computed: _extends({}, (0, _vuex.mapGetters)(['singersong'])),
    mounted: function mounted() {
        // this.singermusic =  this.allsongs.filter((item,index)=>item.name==this.singername);
        this.$store.dispatch('getsingerm', this.$route.params.singername);
    },
    created: function created() {}
};
...
exports.default = {
    data: function data() {
        return {
            isrc: this.$route.query.imgsrc,
            itype: this.$route.params.type,
            ico: "&#xe626;",
            imgs3: [{ pic: "http://39.97.167.207/vueimg/gedan1.jpg", songtype: "唯美" }, { pic: "http://39.97.167.207/vueimg/gedan2.jpg", songtype: "民族" }, { pic: "http://39.97.167.207/vueimg/gedan3.jpg", songtype: "爱情" }, { pic: "http://39.97.167.207/vueimg/gedan4.jpg", songtype: "流行" }]
        };
    },
    ...
    computed: _extends({}, (0, _vuex.mapGetters)(['songlist'])),
    mounted: function mounted() {
        this.$store.dispatch('getsongtype', this.$route.params.type);
    }
};
...
exports.default = {
    ...
    methods: {
        ...
        goindex: function goindex() {
            ...
            if (username != "" && userpwd != "") {
                this.$http.post("http://39.97.167.207:1811/vue/login", { params: { tele: username, pwds: userpwd } }).then(function (res) {
                    if (res.body.code != 200) {
                        _mintUi.MessageBox.alert(res.body.msg);
                    } else {
                        localStorage.username = res.body.result.nike;
                ...
                _mintUi.MessageBox.alert("请填写完整信息");
            }
        }
    }
}; //
...
exports.default = {
    ...
    methods: {
        register: function register() {
            ...
            var usertel = this.$refs.telnum.value;
            var nikename = this.$refs.nikename.value;
            var pwd1 = this.$refs.pwd1.value;
            var pwd2 = this.$refs.pwd2.value;
            var telreg = /^[1][3,4,5,7,8][0-9]{9}$/;
            if (telreg.test(usertel) && nikename != "" && pwd1 != "" && pwd1 == pwd2) {

                this.$http.post("http://39.97.167.207:1811/vue/reg", { params: { tele: usertel, nikes: nikename, pwds: pwd1 } }).then(function (res) {
                    if (res.body.code != 200) {
                        _mintUi.MessageBox.alert(res.body.msg);
                    } else {
                        _mintUi.MessageBox.alert(res.body.msg).then(function (action) {
                ...
                _mintUi.MessageBox.alert("输入格式正确");
            }
        }
    },
    created: function created() {}
...
exports.default = (_data$mounted$methods = {
    data: function data() {
        return {
            pic1: 'http://39.97.167.207/vueimg/nologin.jpg',
            name: this.$route.params.singer,
            song: this.$route.query.songer,
            musciId: this.$route.query.sid,
            songpl: []
        };
    },
    mounted: function mounted() {},
    ...
    methods: _extends({
        golrc: function golrc() {
            this.$router.go(-1);
        },
        toopinion: function toopinion() {
            var content = this.$refs.txtinp.value;
            if (content) {
                ...
                this.$http.get("http://39.97.167.207:1811/vue/opi", { params: { username: user, contents: content, times: nowTime, mId: this.musciId } }).then(function (res) {
                    if (res.body.code == 200) {
                        _mintUi.MessageBox.alert("评论成功").then(function (action) {});
                    }
                });
            } else {
                _mintUi.MessageBox.alert("评论内容不能为空");
            }
        }
    }, (0, _vuex.mapActions)(['getPl'])),
    computed: _extends({}, (0, _vuex.mapState)(['plList']))
}, _defineProperty(_data$mounted$methods, 'mounted', function mounted() {
    var _this = this;

    this.songpl = this.plList.filter(function (item, index) {
        return item.mid == _this.musciId;
    });
}), _defineProperty(_data$mounted$methods, 'created', function created() {
    this.getPl({ url: "http://39.97.167.207:1811/vue/pl" });
...
var _heads = __webpack_require__(78);
...
_vue2.default.component("Heads", _heads2.default);
...
// Module
exports.push([module.i, "", "",{"version":3,"sources":[],"names":[],"mappings":"","file":"App.vue"}]);
...
var _songlrc = __webpack_require__(43);

var _songlrc2 = _interopRequireDefault(_songlrc);

var _songlist = __webpack_require__(47);

var _songlist2 = _interopRequireDefault(_songlist);

var _singer = __webpack_require__(51);

var _singer2 = _interopRequireDefault(_singer);

var _singtype = __webpack_require__(55);

var _singtype2 = _interopRequireDefault(_singtype);
...
var _opinion = __webpack_require__(70);
...
var routes = [{ path: "", redirect: { name: "index" } }, {
    path: "/",
    name: 'app',
    component: _App2.default,
    children: [{ path: "index", name: 'index', component: _index2.default }]
}, { path: "/songlrc/:songId", name: 'songlrc', component: _songlrc2.default }, { path: "/songlist", name: 'songlist', component: _songlist2.default }, { path: "/singer/:singername", name: 'singer', component: _singer2.default }, { path: "/singtype/:type", name: 'singtype', component: _singtype2.default }, { path: "/login", name: 'login', component: _login2.default }, { path: "/register", name: 'register', component: _register2.default }, { path: "/opinion/:singer", name: 'opinion', component: _opinion2.default }, { path: "/", redirect: { name: "index" } }, { path: "*", redirect: { name: "index" } }];
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_47323bf2_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_index_vue__ = __webpack_require__(42);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
  __webpack_require__(32)
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_47323bf2_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_index_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("13899a3d", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js?sourceMap!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-47323bf2\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/_sass-loader@7.1.0@sass-loader/lib/loader.js!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./index.vue", function() {
...
exports = module.exports = __webpack_require__(0)(true);
// Module
exports.push([module.i, "\ndiv .mint-swipe[data-v-47323bf2] {\n  height: 200px;\n}\ndiv .mint-swipe .mint-swipe-items-wrap[data-v-47323bf2] {\n    height: 200px;\n}\ndiv .mint-swipe .mint-swipe-items-wrap .sweiper-nav[data-v-47323bf2] {\n      height: 200px;\n}\ndiv .mint-swipe .mint-swipe-items-wrap .sweiper-nav img[data-v-47323bf2] {\n        height: 100%;\n        width: 100%;\n}\ndiv .hot-singer[data-v-47323bf2] {\n  color: #555;\n  text-indent: 1em;\n  font-weight: 700;\n  font-size: 18px;\n  height: 40px;\n  line-height: 40px;\n  margin-top: 10px;\n}\ndiv .singer[data-v-47323bf2] {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-around;\n}\ndiv .singer div[data-v-47323bf2] {\n    width: 30%;\n}\ndiv .singer div img[data-v-47323bf2] {\n      width: 100%;\n      width: 100%;\n      border-radius: 50%;\n}\ndiv .singer div p[data-v-47323bf2] {\n      width: 100%;\n      height: 30px;\n      line-height: 30px;\n      text-align: center;\n      color: #666;\n}\ndiv .song-list[data-v-47323bf2] {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-around;\n  flex-wrap: wrap;\n}\ndiv .song-list div[data-v-47323bf2] {\n    margin-top: 10px;\n    width: 48%;\n}\ndiv .song-list div img[data-v-47323bf2] {\n      width: 100%;\n      width: 100%;\n}\ndiv .song-list div p[data-v-47323bf2] {\n      width: 100%;\n      height: 30px;\n      line-height: 30px;\n      text-align: center;\n      color: #666;\n}\ndiv .moresong[data-v-47323bf2] {\n  width: 60%;\n  height: 40px;\n  border-radius: 20px;\n  line-height: 40px;\n  text-align: center;\n  color: #eee;\n  margin: 20px auto;\n  background-color: #59a3df;\n}\n", "",{"version":3,"sources":["index.vue"],"names":[],"mappings":";AAAA;EACE,aAAA;AAEF;AADE;IACE,aAAA;AAGJ;AAFI;MACE,aAAA;AAIN;AAHM;QACE,YAAA;QACA,WAAA;AAKR;AAHA;EACE,WAAA;EACA,gBAAA;EACA,gBAAA;EACA,eAAA;EACA,YAAA;EACA,iBAAA;EACA,gBAAA;AAKF;AAHA;EACE,aAAA;EACA,mBAAA;EACA,6BAAA;AAKF;AAJE;IACE,UAAA;AAMJ;AALI;MACE,WAAA;MACA,WAAA;MACA,kBAAA;AAON;AANI;MACE,WAAA;MACA,YAAA;MACA,iBAAA;MACA,kBAAA;MACA,WAAA;AAQN;AANA;EACE,aAAA;EACA,mBAAA;EACA,6BAAA;EACA,eAAA;AAQF;AAPE;IACE,gBAAA;IACA,UAAA;AASJ;AARI;MACE,WAAA;MACA,WAAA;AAUN;AATI;MACE,WAAA;MACA,YAAA;MACA,iBAAA;MACA,kBAAA;MACA,WAAA;AAWN;AATA;EACE,UAAA;EACA,YAAA;EACA,mBAAA;EACA,iBAAA;EACA,kBAAA;EACA,WAAA;EACA,iBAAA;EACA,yBAAA;AAWF","file":"index.vue","sourcesContent":["div .mint-swipe {\n  height: 200px; }\n  div .mint-swipe .mint-swipe-items-wrap {\n    height: 200px; }\n    div .mint-swipe .mint-swipe-items-wrap .sweiper-nav {\n      height: 200px; }\n      div .mint-swipe .mint-swipe-items-wrap .sweiper-nav img {\n        height: 100%;\n        width: 100%; }\n\ndiv .hot-singer {\n  color: #555;\n  text-indent: 1em;\n  font-weight: 700;\n  font-size: 18px;\n  height: 40px;\n  line-height: 40px;\n  margin-top: 10px; }\n\ndiv .singer {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-around; }\n  div .singer div {\n    width: 30%; }\n    div .singer div img {\n      width: 100%;\n      width: 100%;\n      border-radius: 50%; }\n    div .singer div p {\n      width: 100%;\n      height: 30px;\n      line-height: 30px;\n      text-align: center;\n      color: #666; }\n\ndiv .song-list {\n  display: flex;\n  flex-direction: row;\n  justify-content: space-around;\n  flex-wrap: wrap; }\n  div .song-list div {\n    margin-top: 10px;\n    width: 48%; }\n    div .song-list div img {\n      width: 100%;\n      width: 100%; }\n    div .song-list div p {\n      width: 100%;\n      height: 30px;\n      line-height: 30px;\n      text-align: center;\n      color: #666; }\n\ndiv .moresong {\n  width: 60%;\n  height: 40px;\n  border-radius: 20px;\n  line-height: 40px;\n  text-align: center;\n  color: #eee;\n  margin: 20px auto;\n  background-color: #59a3df; }\n"]}]);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_order_vue__ = __webpack_require__(12);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_order_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_order_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_order_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_order_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_5ffcfc6e_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_order_vue__ = __webpack_require__(37);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
  __webpack_require__(35)
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-5ffcfc6e"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_order_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_5ffcfc6e_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_order_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5ffcfc6e", Component.options)
  } else {
    hotAPI.reload("data-v-5ffcfc6e", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("9e24e50c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js?sourceMap!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5ffcfc6e\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/_sass-loader@7.1.0@sass-loader/lib/loader.js!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./order.vue", function() {
     var newContent = require("!!../../node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js?sourceMap!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5ffcfc6e\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/_sass-loader@7.1.0@sass-loader/lib/loader.js!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./order.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
exports = module.exports = __webpack_require__(0)(true);
// Module
exports.push([module.i, "\n.paihang .order-header[data-v-5ffcfc6e] {\n  width: 100%;\n  height: 200px;\n  background: url(http://39.97.167.207/vueimg/beijing1.jpg) no-repeat;\n  background-size: cover;\n}\n.paihang .order-header img[data-v-5ffcfc6e] {\n    height: 75%;\n    width: auto;\n    float: left;\n    margin-top: 25px;\n    margin-left: 25px;\n}\n.paihang .order-header dl[data-v-5ffcfc6e] {\n    float: left;\n    color: #ddd;\n    margin-top: 25px;\n    margin-left: 20px;\n}\n.paihang .order-header dl dt[data-v-5ffcfc6e] {\n      margin-top: 10px;\n      font-size: 18px;\n      line-height: 40px;\n}\n.paihang .order-header dl dd[data-v-5ffcfc6e] {\n      font-size: 16px;\n      line-height: 30px;\n}\n.paihang h2[data-v-5ffcfc6e] {\n  height: 50px;\n  line-height: 50px;\n  text-indent: 1em;\n  color: #666;\n}\n.paihang ul[data-v-5ffcfc6e] {\n  width: 100%;\n}\n.paihang ul li[data-v-5ffcfc6e] {\n    height: 60px;\n    width: 100%;\n    background-color: #eee;\n    border-bottom: 3px solid #ddd;\n}\n.paihang ul li span[data-v-5ffcfc6e] {\n      float: left;\n      width: 20%;\n      height: 60px;\n      line-height: 60px;\n      font-size: 24px;\n      font-weight: 700;\n      text-align: center;\n      color: #888;\n}\n.paihang ul li h3[data-v-5ffcfc6e] {\n      line-height: 35px;\n      color: #666;\n      float: left;\n      width: 60%;\n}\n.paihang ul li p[data-v-5ffcfc6e] {\n      font-size: 14px;\n      color: #666;\n      width: 60%;\n      float: left;\n}\n.paihang ul li i[data-v-5ffcfc6e] {\n      float: left;\n      width: 20%;\n      height: 60px;\n      font-size: 30px;\n      margin-top: -35px;\n      line-height: 60px;\n      text-align: center;\n      color: #777;\n}\n", "",{"version":3,"sources":["order.vue"],"names":[],"mappings":";AAAA;EACE,WAAA;EACA,aAAA;EACA,mEAAA;EACA,sBAAA;AAEF;AADE;IACE,WAAA;IACA,WAAA;IACA,WAAA;IACA,gBAAA;IACA,iBAAA;AAGJ;AAFE;IACE,WAAA;IACA,WAAA;IACA,gBAAA;IACA,iBAAA;AAIJ;AAHI;MACE,gBAAA;MACA,eAAA;MACA,iBAAA;AAKN;AAJI;MACE,eAAA;MACA,iBAAA;AAMN;AAJA;EACE,YAAA;EACA,iBAAA;EACA,gBAAA;EACA,WAAA;AAMF;AAJA;EACE,WAAA;AAMF;AALE;IACE,YAAA;IACA,WAAA;IACA,sBAAA;IACA,6BAAA;AAOJ;AANI;MACE,WAAA;MACA,UAAA;MACA,YAAA;MACA,iBAAA;MACA,eAAA;MACA,gBAAA;MACA,kBAAA;MACA,WAAA;AAQN;AAPI;MACE,iBAAA;MACA,WAAA;MACA,WAAA;MACA,UAAA;AASN;AARI;MACE,eAAA;MACA,WAAA;MACA,UAAA;MACA,WAAA;AAUN;AATI;MACE,WAAA;MACA,UAAA;MACA,YAAA;MACA,eAAA;MACA,iBAAA;MACA,iBAAA;MACA,kBAAA;MACA,WAAA;AAWN","file":"order.vue","sourcesContent":[".paihang .order-header {\n  width: 100%;\n  height: 200px;\n  background: url(http://39.97.167.207/vueimg/beijing1.jpg) no-repeat;\n  background-size: cover; }\n  .paihang .order-header img {\n    height: 75%;\n    width: auto;\n    float: left;\n    margin-top: 25px;\n    margin-left: 25px; }\n  .paihang .order-header dl {\n    float: left;\n    color: #ddd;\n    margin-top: 25px;\n    margin-left: 20px; }\n    .paihang .order-header dl dt {\n      margin-top: 10px;\n      font-size: 18px;\n      line-height: 40px; }\n    .paihang .order-header dl dd {\n      font-size: 16px;\n      line-height: 30px; }\n\n.paihang h2 {\n  height: 50px;\n  line-height: 50px;\n  text-indent: 1em;\n  color: #666; }\n\n.paihang ul {\n  width: 100%; }\n  .paihang ul li {\n    height: 60px;\n    width: 100%;\n    background-color: #eee;\n    border-bottom: 3px solid #ddd; }\n    .paihang ul li span {\n      float: left;\n      width: 20%;\n      height: 60px;\n      line-height: 60px;\n      font-size: 24px;\n      font-weight: 700;\n      text-align: center;\n      color: #888; }\n    .paihang ul li h3 {\n      line-height: 35px;\n      color: #666;\n      float: left;\n      width: 60%; }\n    .paihang ul li p {\n      font-size: 14px;\n      color: #666;\n      width: 60%;\n      float: left; }\n    .paihang ul li i {\n      float: left;\n      width: 20%;\n      height: 60px;\n      font-size: 30px;\n      margin-top: -35px;\n      line-height: 60px;\n      text-align: center;\n      color: #777; }\n"]}]);
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _c("div", { staticClass: "paihang" }, [
      ...
      _vm._l(_vm.songs, function(song, i) {
        return _c(
          ...
          [
            ...
            _vm._v(" "),
            _c("h3", [_vm._v(_vm._s(song.musicname))]),
            _vm._v(" "),
            _c("p", [_vm._v(_vm._s(song.name))]),
            _vm._v(" "),
            _c("i", {
              staticClass: "iconfont",
              domProps: { innerHTML: _vm._s(_vm.ico) }
            })
          ]
        )
      }),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-5ffcfc6e", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_mine_vue__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_fe11ea3a_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_mine_vue__ = __webpack_require__(41);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
  __webpack_require__(39)
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-fe11ea3a"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_fe11ea3a_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_mine_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-fe11ea3a", Component.options)
  } else {
    hotAPI.reload("data-v-fe11ea3a", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("f225ed12", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js?sourceMap!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-fe11ea3a\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/_sass-loader@7.1.0@sass-loader/lib/loader.js!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./mine.vue", function() {
...
exports = module.exports = __webpack_require__(0)(true);
// Module
exports.push([module.i, "\n.minemsg[data-v-fe11ea3a] {\n  width: 100%;\n  height: 100px;\n  line-height: 100px;\n  border-bottom: 1px solid #ddd;\n  border-top: 1px solid #ddd;\n  display: flex;\n  justify-content: space-around;\n}\n.minemsg img[data-v-fe11ea3a] {\n    height: 70%;\n    border-radius: 50%;\n    margin-top: 15px;\n}\n.minemsg i[data-v-fe11ea3a] {\n    color: #26a2ff;\n}\n.mylike[data-v-fe11ea3a] {\n  display: flex;\n  width: 100%;\n  height: 80px;\n  justify-content: space-around;\n  border-bottom: 1px solid #ddd;\n}\n.mylike li[data-v-fe11ea3a] {\n    text-align: center;\n}\n.mylike li i[data-v-fe11ea3a] {\n      font-size: 40px;\n      color: #888;\n}\n.mylike li p[data-v-fe11ea3a] {\n      color: #888;\n}\n.exitbtn[data-v-fe11ea3a] {\n  width: 60%;\n  height: 40px;\n  border-radius: 6px;\n  text-align: center;\n  line-height: 40px;\n  color: #eee;\n  background-color: #26a2ff;\n  position: fixed;\n  left: 50%;\n  bottom: 30px;\n  transform: translateX(-50%);\n}\n", "",{"version":3,"sources":["mine.vue"],"names":[],"mappings":";AAAA;EACE,WAAA;EACA,aAAA;EACA,kBAAA;EACA,6BAAA;EACA,0BAAA;EACA,aAAA;EACA,6BAAA;AAEF;AADE;IACE,WAAA;IACA,kBAAA;IACA,gBAAA;AAGJ;AAFE;IACE,cAAA;AAIJ;AAFA;EACE,aAAA;EACA,WAAA;EACA,YAAA;EACA,6BAAA;EACA,6BAAA;AAIF;AAHE;IACE,kBAAA;AAKJ;AAJI;MACE,eAAA;MACA,WAAA;AAMN;AALI;MACE,WAAA;AAON;AALA;EACE,UAAA;EACA,YAAA;EACA,kBAAA;EACA,kBAAA;EACA,iBAAA;EACA,WAAA;EACA,yBAAA;EACA,eAAA;EACA,SAAA;EACA,YAAA;EACA,2BAAA;AAOF","file":"mine.vue","sourcesContent":[".minemsg {\n  width: 100%;\n  height: 100px;\n  line-height: 100px;\n  border-bottom: 1px solid #ddd;\n  border-top: 1px solid #ddd;\n  display: flex;\n  justify-content: space-around; }\n  .minemsg img {\n    height: 70%;\n    border-radius: 50%;\n    margin-top: 15px; }\n  .minemsg i {\n    color: #26a2ff; }\n\n.mylike {\n  display: flex;\n  width: 100%;\n  height: 80px;\n  justify-content: space-around;\n  border-bottom: 1px solid #ddd; }\n  .mylike li {\n    text-align: center; }\n    .mylike li i {\n      font-size: 40px;\n      color: #888; }\n    .mylike li p {\n      color: #888; }\n\n.exitbtn {\n  width: 60%;\n  height: 40px;\n  border-radius: 6px;\n  text-align: center;\n  line-height: 40px;\n  color: #eee;\n  background-color: #26a2ff;\n  position: fixed;\n  left: 50%;\n  bottom: 30px;\n  transform: translateX(-50%); }\n"]}]);
...
var render = function() {
  ...
  return _c("div", [
    ...
    _c(
      "ul",
      { staticClass: "mylike" },
      _vm._l(_vm.icons, function(mineico, i) {
        return _c("li", { key: i }, [
          _c("i", {
            staticClass: "iconfont",
            domProps: { innerHTML: _vm._s(mineico.icon) }
          }),
          _vm._v(" "),
          _c("p", [_vm._v(_vm._s(mineico.msg))])
        ])
      }),
      0
    ),
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-fe11ea3a", esExports)
  }
}
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("Heads", { attrs: { title: "江湖音乐" } }),
      _vm._v(" "),
      _c(
        "mt-navbar",
        {
          staticClass: "top-bar1",
          model: {
            value: _vm.selected,
            callback: function($$v) {
              _vm.selected = $$v
        ...
        [
          _c("mt-tab-item", { attrs: { id: "1" } }, [_vm._v("推荐")]),
          _vm._v(" "),
          _c("mt-tab-item", { attrs: { id: "2" } }, [_vm._v("排行榜")]),
          _vm._v(" "),
          _c("mt-tab-item", { attrs: { id: "3" } }, [_vm._v("我的")])
        ],
        1
      ),
      _vm._v(" "),
      _c(
        ...
        [
            ...
            [
              _c(
                ...
                _vm._l(_vm.imgs, function(img, index) {
                  return _c(
                    "mt-swipe-item",
                    { key: index, staticClass: "sweiper-nav" },
                    [_c("img", { attrs: { src: img.he, alt: "" } })]
                  )
                }),
                1
              ),
              _vm._v(" "),
              _c("h2", { staticClass: "hot-singer" }, [_vm._v("热门歌手")]),
              _vm._v(" "),
              _c(
                "div",
                { staticClass: "singer" },
                _vm._l(_vm.imgs2, function(img1, i) {
                  return _c(
                    "div",
                    {
                      key: i,
                      on: {
                        click: function($event) {
                          return _vm.goSinger(img1.name)
                        }
                      }
                    },
                    [
                      _c("img", { attrs: { src: img1.pic, alt: "" } }),
                      _vm._v(" "),
                      _c("p", [_vm._v(_vm._s(img1.name))])
                    ]
                  )
                }),
                0
              ...
              _vm._v(" "),
              _c("h2", { staticClass: "hot-singer" }, [_vm._v("热门歌单")]),
              _vm._v(" "),
              _c(
                "div",
                { staticClass: "song-list" },
                _vm._l(_vm.imgs3, function(img4, i) {
                  return _c(
                    "div",
                    {
                      key: i,
                      on: {
                        click: function($event) {
                          return _vm.goSongtype(img4.songtype, img4.pic)
                        }
                      }
                    },
                    [
                      _c("img", { attrs: { src: img4.pic, alt: "" } }),
                      _vm._v(" "),
                      _c("p", [_vm._v(_vm._s(img4.name))])
                    ]
                  )
                }),
                0
          ...
          _vm._v(" "),
          _c("mt-tab-container-item", { attrs: { id: "2" } }, [_c("Order")], 1),
          _vm._v(" "),
          _c("mt-tab-container-item", { attrs: { id: "3" } }, [_c("Mine")], 1)
        ],
        1
      )
    ],
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-47323bf2", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_songlrc_vue__ = __webpack_require__(14);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_songlrc_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_songlrc_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_songlrc_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_songlrc_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_d9215584_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_songlrc_vue__ = __webpack_require__(46);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
  __webpack_require__(44)
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-d9215584"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_songlrc_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_d9215584_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_songlrc_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/views/songlrc.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-d9215584", Component.options)
  } else {
    hotAPI.reload("data-v-d9215584", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("4b12656c", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js?sourceMap!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-d9215584\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./songlrc.vue", function() {
     var newContent = require("!!../../node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js?sourceMap!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-d9215584\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./songlrc.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
exports = module.exports = __webpack_require__(0)(true);
// Module
exports.push([module.i, "\n.lrcbox[data-v-d9215584]{\r\n    width: 100%;\r\n    height: 100vh;\r\n    background: url(http://39.97.167.207/vueimg/bg.jpg) no-repeat;\r\n    background-size: cover;\n}\n.details_lyric[data-v-d9215584]{\r\n\twidth: 100%;\r\n\tposition: absolute;\r\n\ttop: 40px;\r\n\tbottom: 150px;\r\n\toverflow: hidden;\r\n\ttransition: 0.5s;\r\n\t-webkit-transition: 0.5s;\n}\n.details_lyric ul[data-v-d9215584]{\r\n\twidth: 100%;\r\n\ttext-align: center;\r\n\tcolor: white;\r\n\tfont-size: 14px;\r\n\tposition: absolute;\r\n\ttop: 0;\r\n\tleft: 0;\r\n\ttransition: 0.3s;\r\n\t-webkit-transition: 0.3s;\n}\n.details_lyric li[data-v-d9215584]{\r\n\tmargin-top: 15px;\n}\n.details_lyric li.active[data-v-d9215584]{\r\n\tcolor: #00ffff;\n}\n.details_audio[data-v-d9215584]{\r\n\twidth: 100%;\r\n\theight: 150px;\r\n\tposition: absolute;\r\n\tbottom: 0;\r\n\ttransition: 0.5s;\r\n\t-webkit-transition: 0.5s;\n}\n.details_audioAll[data-v-d9215584]{\r\n\twidth: 200px;\r\n\tmargin: 20px auto;\r\n\tposition: relative;\n}\n.details_audioPro[data-v-d9215584]{\r\n\twidth: 100%;\r\n\theight: 2px;\r\n\tbackground: white;\n}\n.details_audioProUp[data-v-d9215584]{\r\n\twidth: 0;\r\n\theight: 2px;\r\n\tbackground: #29abe2;\r\n\tposition: absolute;\r\n\tleft: 0;\r\n\ttop: 0;\n}\n.details_audioProBar[data-v-d9215584]{\r\n\twidth: 15px;\r\n\theight: 15px;\r\n\tbackground: #29abe2;\r\n\tborder-radius: 50%;\r\n\tposition: absolute;\r\n\ttop: 0;\r\n\tleft: 0;\r\n\tmargin: -7px;\n}\n.details_nowTime[data-v-d9215584]{\r\n\tfont-size: 12px;\r\n\tcolor: #ebdddd;\r\n\tposition: absolute;\r\n\ttop: -8px;\r\n\tleft: -40px;\n}\n.details_allTime[data-v-d9215584]{\r\n\tfont-size: 12px;\r\n\tcolor: #ebdddd;\r\n\tposition: absolute;\r\n\ttop: -8px;\r\n\tright: -40px;\n}\n.details_play[data-v-d9215584]{\r\n\twidth: 55px;\r\n\theight: 55px;\r\n\tposition: absolute;\r\n\tleft: 50%;\r\n\tmargin-left: -27px;\r\n\ttop: 30px;\n}\n.details_play img[data-v-d9215584]{\r\n\twidth: 55px;\r\n\theight: 55px;\n}\n.details_prev[data-v-d9215584]{\r\n\twidth: 37px;\r\n\theight: 37px;\r\n\tbackground: url(http://39.97.167.207/vueimg/details_prev.png) no-repeat;\r\n\tbackground-size: cover;\r\n\tposition: absolute;\r\n\tleft: 10px;\r\n\ttop: 37px;\n}\n.details_next[data-v-d9215584]{\r\n\twidth: 37px;\r\n\theight: 37px;\r\n\tbackground: url(http://39.97.167.207/vueimg/details_next.png) no-repeat;\r\n\tbackground-size: cover;\r\n\tposition: absolute;\r\n\tright: 10px;\r\n\ttop: 37px;\n}\n.shouchang[data-v-d9215584]{\r\n\tposition: absolute;\r\n\tfont-size: 45px;\r\n\tcolor: #29abe2;\r\n\tright: -50px;\r\n\ttop: 34px;\n}\n.pinglun[data-v-d9215584]{\r\n\tposition: absolute;\r\n\tfont-size: 40px;\r\n\tcolor: #29abe2;\r\n\tleft: -50px;\r\n\ttop: 34px;\n}\r\n", "",{"version":3,"sources":["src/views/songlrc.vue","songlrc.vue"],"names":[],"mappings":";AA6OA;IACA,WAAA;IACA,aAAA;IACA,6DAAA;IACA,sBAAA;AC3OA;AD6OA;CACA,WAAA;CACA,kBAAA;CACA,SAAA;CACA,aAAA;CACA,gBAAA;CACA,gBAAA;CACA,wBAAA;AC3OA;AD6OA;CACA,WAAA;CACA,kBAAA;CACA,YAAA;CACA,eAAA;CACA,kBAAA;CACA,MAAA;CACA,OAAA;CACA,gBAAA;CACA,wBAAA;AC3OA;AD6OA;CACA,gBAAA;AC3OA;AD6OA;CACA,cAAA;AC3OA;AD8OA;CACA,WAAA;CACA,aAAA;CACA,kBAAA;CACA,SAAA;CACA,gBAAA;CACA,wBAAA;AC5OA;AD8OA;CACA,YAAA;CACA,iBAAA;CACA,kBAAA;AC5OA;AD8OA;CACA,WAAA;CACA,WAAA;CACA,iBAAA;AC5OA;AD8OA;CACA,QAAA;CACA,WAAA;CACA,mBAAA;CACA,kBAAA;CACA,OAAA;CACA,MAAA;AC5OA;AD8OA;CACA,WAAA;CACA,YAAA;CACA,mBAAA;CACA,kBAAA;CACA,kBAAA;CACA,MAAA;CACA,OAAA;CACA,YAAA;AC5OA;AD8OA;CACA,eAAA;CACA,cAAA;CACA,kBAAA;CACA,SAAA;CACA,WAAA;AC5OA;AD8OA;CACA,eAAA;CACA,cAAA;CACA,kBAAA;CACA,SAAA;CACA,YAAA;AC5OA;AD8OA;CACA,WAAA;CACA,YAAA;CACA,kBAAA;CACA,SAAA;CACA,kBAAA;CACA,SAAA;AC5OA;AD8OA;CACA,WAAA;CACA,YAAA;AC5OA;AD8OA;CACA,WAAA;CACA,YAAA;CACA,uEAAA;CACA,sBAAA;CACA,kBAAA;CACA,UAAA;CACA,SAAA;AC5OA;AD8OA;CACA,WAAA;CACA,YAAA;CACA,uEAAA;CACA,sBAAA;CACA,kBAAA;CACA,WAAA;CACA,SAAA;AC5OA;AD8OA;CACA,kBAAA;CACA,eAAA;CACA,cAAA;CACA,YAAA;CACA,SAAA;AC5OA;AD8OA;CACA,kBAAA;CACA,eAAA;CACA,cAAA;CACA,WAAA;CACA,SAAA;AC5OA","file":"songlrc.vue","sourcesContent":["<template>\r\n    <div class=\"lrcbox\" v-if=\"onesong.length>0\">\r\n        <Heads :title=\"onesong[0].musicname\" > </Heads>\r\n        <div id=\"detailsLyric\" class=\"details_lyric\">\r\n  \t    \t<ul id=\"detailsLyricUl\" ref=\"scrollul\">\r\n  \t    \t\t<li v-for=\"(word,i) in songlrc\" :key=\"i\" ref=\"one\">{{word}}</li>\r\n  \t    \t</ul>\r\n  \t    </div>\r\n        <div class=\"details_audio\">\r\n  \t    \t<div class=\"details_audioAll\">\r\n  \t    \t\t<div class=\"details_audioPro\">\r\n  \t    \t\t\t<div class=\"details_audioProUp\" ref=\"kuan\"></div>\r\n  \t    \t\t\t<div class=\"details_audioProBar\" ref=\"lefts\"></div>\r\n  \t    \t\t</div>\r\n  \t    \t\t<div class=\"details_nowTime\">{{time.ctime}}</div>\r\n  \t    \t\t<div class=\"details_allTime\">{{time.ttime}}</div>\r\n  \t    \t\t<div class=\"details_play\" @click=\"playaudio\">\r\n\t\t\t\t\t<img src=\"images/details_play.png\" alt=\"\" v-if=\"!show\">\r\n\t\t\t\t\t<img src=\"images/details_pause.png\" alt=\"\" v-if=\"show\">\r\n\t\t\t\t</div>\r\n  \t    \t\t<div class=\"details_prev\" @click=\"prevSong(onesong[0].songId)\"></div>\r\n  \t    \t\t<div class=\"details_next\" @click=\"nextSong(onesong[0].songId)\"></div>\r\n\t\t\t\t<i class=\"shouchang iconfont\" v-html=\"ico\" @click=\"mylove()\"></i>\r\n\t\t\t\t<span class=\"pinglun iconfont\" v-html=\"ico2\" @click=\"pinglun(onesong[0].name,onesong[0].musicname,onesong[0].songId)\"></span>\r\n  \t    \t</div>\r\n  \t    </div>\r\n        <audio :src=\"'images/'+onesong[0].audio\" @canplay=\"allTime()\" @timeupdate=\"updadteTime()\" @ended=\"ended()\" :flag=\"autop\" autoplay ref=\"playmusic\"></audio>\r\n    </div>\r\n</template>\r\n\r\n<script>\r\nimport {mapState,mapActions,mapGetters} from \"vuex\";\r\nimport { setTimeout } from 'timers';\r\nvar myAudio = null;\r\nexport default {\r\n    data(){\r\n        return{\r\n\t\t\ttime:{\r\n\t\t\t\tttime:null,\r\n\t\t\t\tctime:null,\r\n\t\t\t\tttimes:null,\t\t\r\n\t\t\t},\t\r\n\t\t\tctimes:null,\t\r\n\t\t\tshow:true,\r\n\t\t\tautop:1,\r\n\t\t\t// playimg:require('/images/details_play.png'),\r\n\t\t\t// playimg2:require('/images/details_pause.png'),\r\n\t\t\tico:\"&#xe607;\",\r\n\t\t\tico2:\"&#xe60c;\"\r\n        }\r\n\t},\r\n\twatch:{\r\n\t\tsclca(val){\r\n\t\t\tthis.$refs.kuan.style.width = val;\r\n\t\t\tthis.$refs.lefts.style.left = val;\r\n\t\t},\r\n\t\tctimes(oldval){\r\n\t\t\tfor(var i=0;i<this.geshitime.length;i++){\r\n\t\t\t\tlet stops = -(this.$refs.one[i].clientHeight);\r\n\t\t\t\tif(i!=this.geshitime.length-1&&oldval>this.geshitime[i]*1&&oldval<this.geshitime[i+1]*1){\r\n\t\t\t\t\tthis.$refs.one[i].className=\"active\";\t\r\n\t\t\t\t\tif(i>4){\r\n\t\t\t\t\t\tif(stops==0){\r\n\t\t\t\t\t\t\tstops = -(this.$refs.one[i-1].clientHeight);\r\n\t\t\t\t\t\t\ti = i--;\r\n\t\t\t\t\t\t\tthis.$refs.scrollul.style.WebkitTransform = \"translate3d(0,\"+stops*(i-4)+\"px,0)\"\r\n\t\t\t\t\t\t}else{\r\n\t\t\t\t\t\t\tthis.$refs.scrollul.style.WebkitTransform = \"translate3d(0,\"+stops*(i-4)+\"px,0)\"\r\n\t\t\t\t\t\t}\r\n\t\t\t\t\t\t// this.$refs.scrollul.style.WebkitTransform = \"translate3d(0,\"+this.stops*i+\"px,0)\"\r\n\t\t\t\t\t}else{\r\n\t\t\t\t\t\tthis.$refs.scrollul.style.WebkitTransform = \"translate3d(0,0,0)\"\r\n\t\t\t\t\t}\r\n\t\t\t\t\t\r\n\t\t\t\t}else{\r\n\t\t\t\t\tthis.$refs.one[i].className=\"\"\r\n\t\t\t\t}\r\n\t\t\t}\r\n\t\t}\r\n\t},\r\n    methods:{\r\n\t\t...mapActions(['getAllsongs']),\r\n\t\tupdadteTime(){\r\n\t\t\tlet min = this.$refs.playmusic.currentTime/60|0;\r\n\t\t\tlet sec = this.$refs.playmusic.currentTime%60|0;\r\n\t\t\tmin = min>=10?min:\"0\"+min\r\n\t\t\tsec = sec>=10?sec:\"0\"+sec\r\n\t\t\tlet alltimer = min+\":\"+sec;\r\n\t\t\tthis.ctimes = this.$refs.playmusic.currentTime.toFixed(2);\r\n\t\t\tthis.time.ctime = alltimer;\r\n\t\t},\r\n\t\tallTime(){\r\n\t\t\tlet min = this.$refs.playmusic.duration/60|0;\r\n\t\t\tlet sec = this.$refs.playmusic.duration%60|0;\r\n\t\t\tmin = min>=10?min:\"0\"+min\r\n\t\t\tsec = sec>=10?sec:\"0\"+sec\r\n\t\t\tlet alltimer = min+\":\"+sec;\r\n\t\t\tthis.time.ttimes = this.$refs.playmusic.duration;\r\n\t\t\tthis.time.ttime = alltimer;\r\n\t\t},\r\n\t\tended(){  //播放结束 自动切换下一首\r\n\t\t\tlet songid = this.onesong[0].songId;\r\n\t\t\tif(songid==this.allsongs.length){\r\n\t\t\t\tsongid=1;\r\n\t\t\t\tthis.$router.push({name:\"songlrc\",params:{songId:songid}})\r\n\t\t\t\twindow.location.reload();\r\n\t\t\t}else{\r\n\t\t\t\tsongid++;\r\n\t\t\t\tthis.$router.push({name:\"songlrc\",params:{songId:songid}})\r\n\t\t\t\twindow.location.reload();\r\n\t\t\t}\r\n\t\t},\r\n        prevSong(id){\r\n\t\t\tif(id == 1){\r\n\t\t\t\tid=this.allsongs.length\r\n\t\t\t\tthis.$router.push({name:\"songlrc\",params:{songId:id}})\r\n\t\t\t\twindow.location.reload();\r\n\t\t\t}else{\r\n\t\t\t\tid--;\r\n\t\t\t\tthis.$router.push({name:\"songlrc\",params:{songId:id}})\r\n\t\t\t\twindow.location.reload();\r\n\t\t\t}\r\n\t\t\t\t\r\n\t\t},\r\n\t\tnextSong(id){\r\n\t\t\tif(id==this.allsongs.length){\r\n\t\t\t\tid=1;\r\n\t\t\t\tthis.$router.push({name:\"songlrc\",params:{songId:id}})\r\n\t\t\t\twindow.location.reload();\r\n\t\t\t}else{\r\n\t\t\t\tid++;\r\n\t\t\t\tthis.$router.push({name:\"songlrc\",params:{songId:id}})\r\n\t\t\t\twindow.location.reload();\r\n\t\t\t}\r\n\t\t\t\t\r\n\t\t},\r\n\t\tplayaudio(){\r\n\t\t\tif(this.autop==0){\r\n\t\t\t\tthis.show=!this.show;\r\n\t\t\t\tthis.$refs.playmusic.play();\r\n\t\t\t\tthis.autop=1;\r\n\t\t\t}else{\r\n\t\t\t\tthis.$refs.playmusic.pause();\r\n\t\t\t\tthis.autop=0;\r\n\t\t\t\tthis.show=!this.show;\r\n\t\t\t}\r\n\t\t},\r\n\t\tmylove(){\r\n\t\t\tif(localStorage.username){\r\n\t\t\t\tlet num = this.onesong[0].hotnum;\r\n\t\t\t\tnum++;\r\n\t\t\t\tthis.$http.get(\"http://39.97.167.207:1811/vue/hotcount\",{params:{musicid:this.onesong[0].songId,countnum:num}}).then(res=>{\r\n\t\t\t\t\t\r\n\t\t\t\t})\r\n\t\t\t}else{\r\n\t\t\t\tthis.$router.push({name:\"login\"})\r\n\t\t\t}\r\n\t\t},\r\n\t\tpinglun(names,songname,id){\r\n\t\t\tif(localStorage.username){\r\n\t\t\t\tthis.$router.push({name:\"opinion\",params:{singer:names},query:{songer:songname,sid:id}})\r\n\t\t\t}else{\r\n\t\t\t\tthis.$router.push({name:\"login\"})\r\n\t\t\t}\r\n\t\t}\r\n\t},\r\n\tcomputed:{\r\n\t\t ...mapState(['allsongs']),\r\n\t\t ...mapGetters(['onesong']),\r\n\t\t songlrc:function(){\r\n\t\t\t var geci =[];\r\n\t\t\t var re = /\\[[^[]+/g;\r\n\t\t\t var lrc= this.onesong[0].lyric.match(re);\r\n\t\t\tfor(var i=0;i<lrc.length;i++){\r\n\t\t\t\tvar onelrc = lrc[i];\r\n\t\t\t\tgeci.push(onelrc.split(\"]\")[1]);\r\n\t\t\t}\r\n\t\t\treturn geci;\r\n\t\t },\r\n\t\t sclca:function(){   //就算百分比\r\n\t\t\tvar bfb = (this.ctimes/this.time.ttimes*100).toFixed(2)+\"%\"\r\n\t\t\treturn bfb\r\n\t\t },\r\n\t\t suiyi:function(){\r\n\t\t\t var geci =[];\r\n\t\t\t var re = /\\[[^[]+/g;\r\n\t\t\t var lrc= this.onesong[0].lyric.match(re);\r\n\t\t\t for(var i=0;i<lrc.length;i++){\r\n\t\t\t\t lrc[i]=[(lrc[i].substring(0,10)).substring(1,9),lrc[i].substring(10)]\r\n\t\t\t\t geci.push(lrc[i])\r\n\t\t\t }\r\n\t\t\treturn geci;\r\n\t\t },\r\n\t\t geshitime:function(){\r\n\t\t\t var st = [];\r\n\t\t\t for(var i=0;i<this.suiyi.length;i++){\r\n\t\t\t\t var onest = this.suiyi[i][0].split(\":\")[0]*60+this.suiyi[i][0].split(\":\")[1]*1\r\n\t\t\t\t st.push(onest.toFixed(2))\r\n\t\t\t }\r\n\t\t\t return st\r\n\t\t }\r\n\t\t\r\n\r\n\t},\r\n\tupdated(){\r\n\t\t\r\n\t},\r\n\tmounted(){\r\n\t\t// this.onesong =  this.allsongs.filter((item,index)=>item.songId==this.$route.params.songId);\r\n\t\tthis.$store.dispatch('getSong',this.$route.params.songId);\r\n\r\n\t\t// setTimeout(()=>{\r\n\t\t// \tvar myAudio = this.$refs.playmusic;\r\n\t\t// \tconsole.log(myAudio)\r\n\t\t// \tmyAudio.addEventListener(\"ended\",()=>{\r\n\t\t// \t\tconsole.log(66);\r\n\t\t// \t\tlet songid = this.onesong[0].songId;\r\n\t\t// \t\tsongid++;\r\n\t\t// \t\tthis.$router.push({name:\"songlrc\",params:{songId:songid}})\r\n\t\t// \t\twindow.location.reload();\r\n\t\t// \t\t// console.log(myAudio.duration);\r\n\t\t// \t})\r\n\t\t// },100)\r\n\t\t\r\n    },\r\n    created(){\r\n        // this.$http.get(\"http://39.97.167.207:1810/vue/onesong\",{params:{id:this.onesongId}}).then(res=>{\r\n        //     this.onesong = res.data.result;\r\n        //     console.log(this.onesong)\r\n\t\t// })\r\n\t\tthis.getAllsongs({url:'http://39.97.167.207:1811/vue/allsongs'})\r\n    }\r\n}\r\n</script>\r\n\r\n<style scoped>\r\n\r\n.lrcbox{\r\n    width: 100%;\r\n    height: 100vh;\r\n    background: url(http://39.97.167.207/vueimg/bg.jpg) no-repeat;\r\n    background-size: cover;\r\n}\r\n.details_lyric{\r\n\twidth: 100%;\r\n\tposition: absolute;\r\n\ttop: 40px;\r\n\tbottom: 150px;\r\n\toverflow: hidden;\r\n\ttransition: 0.5s;\r\n\t-webkit-transition: 0.5s;\r\n}\r\n.details_lyric ul{\r\n\twidth: 100%;\r\n\ttext-align: center;\r\n\tcolor: white;\r\n\tfont-size: 14px;\r\n\tposition: absolute;\r\n\ttop: 0;\r\n\tleft: 0;\r\n\ttransition: 0.3s;\r\n\t-webkit-transition: 0.3s;\r\n}\r\n.details_lyric li{\r\n\tmargin-top: 15px;\r\n}\r\n.details_lyric li.active{\r\n\tcolor: #00ffff;\r\n}\r\n\r\n.details_audio{\r\n\twidth: 100%;\r\n\theight: 150px;\r\n\tposition: absolute;\r\n\tbottom: 0;\r\n\ttransition: 0.5s;\r\n\t-webkit-transition: 0.5s;\r\n}\r\n.details_audioAll{\r\n\twidth: 200px;\r\n\tmargin: 20px auto;\r\n\tposition: relative;\r\n}\r\n.details_audioPro{\r\n\twidth: 100%;\r\n\theight: 2px;\r\n\tbackground: white;\r\n}\r\n.details_audioProUp{\r\n\twidth: 0;\r\n\theight: 2px;\r\n\tbackground: #29abe2;\r\n\tposition: absolute;\r\n\tleft: 0;\r\n\ttop: 0;\r\n}\r\n.details_audioProBar{\r\n\twidth: 15px;\r\n\theight: 15px;\r\n\tbackground: #29abe2;\r\n\tborder-radius: 50%;\r\n\tposition: absolute;\r\n\ttop: 0;\r\n\tleft: 0;\r\n\tmargin: -7px; \r\n}\r\n.details_nowTime{\r\n\tfont-size: 12px;\r\n\tcolor: #ebdddd;\r\n\tposition: absolute;\r\n\ttop: -8px;\r\n\tleft: -40px;\r\n}\r\n.details_allTime{\r\n\tfont-size: 12px;\r\n\tcolor: #ebdddd;\r\n\tposition: absolute;\r\n\ttop: -8px;\r\n\tright: -40px;\r\n}\r\n.details_play{\r\n\twidth: 55px;\r\n\theight: 55px;\r\n\tposition: absolute;\r\n\tleft: 50%;\r\n\tmargin-left: -27px;\r\n\ttop: 30px;\r\n}\r\n.details_play img{\r\n\twidth: 55px;\r\n\theight: 55px;\r\n}\r\n.details_prev{\r\n\twidth: 37px;\r\n\theight: 37px;\r\n\tbackground: url(http://39.97.167.207/vueimg/details_prev.png) no-repeat;\r\n\tbackground-size: cover;\r\n\tposition: absolute;\r\n\tleft: 10px;\r\n\ttop: 37px;\r\n}\r\n.details_next{\r\n\twidth: 37px;\r\n\theight: 37px;\r\n\tbackground: url(http://39.97.167.207/vueimg/details_next.png) no-repeat;\r\n\tbackground-size: cover;\r\n\tposition: absolute;\r\n\tright: 10px;\r\n\ttop: 37px;\r\n}\r\n.shouchang{\r\n\tposition: absolute;\r\n\tfont-size: 45px;\r\n\tcolor: #29abe2;\r\n\tright: -50px;\r\n\ttop: 34px;\r\n}\r\n.pinglun{\r\n\tposition: absolute;\r\n\tfont-size: 40px;\r\n\tcolor: #29abe2;\r\n\tleft: -50px;\r\n\ttop: 34px;\r\n}\r\n</style>\r\n\r\n","\n.lrcbox[data-v-d9215584]{\r\n    width: 100%;\r\n    height: 100vh;\r\n    background: url(http://39.97.167.207/vueimg/bg.jpg) no-repeat;\r\n    background-size: cover;\n}\n.details_lyric[data-v-d9215584]{\r\n\twidth: 100%;\r\n\tposition: absolute;\r\n\ttop: 40px;\r\n\tbottom: 150px;\r\n\toverflow: hidden;\r\n\ttransition: 0.5s;\r\n\t-webkit-transition: 0.5s;\n}\n.details_lyric ul[data-v-d9215584]{\r\n\twidth: 100%;\r\n\ttext-align: center;\r\n\tcolor: white;\r\n\tfont-size: 14px;\r\n\tposition: absolute;\r\n\ttop: 0;\r\n\tleft: 0;\r\n\ttransition: 0.3s;\r\n\t-webkit-transition: 0.3s;\n}\n.details_lyric li[data-v-d9215584]{\r\n\tmargin-top: 15px;\n}\n.details_lyric li.active[data-v-d9215584]{\r\n\tcolor: #00ffff;\n}\n.details_audio[data-v-d9215584]{\r\n\twidth: 100%;\r\n\theight: 150px;\r\n\tposition: absolute;\r\n\tbottom: 0;\r\n\ttransition: 0.5s;\r\n\t-webkit-transition: 0.5s;\n}\n.details_audioAll[data-v-d9215584]{\r\n\twidth: 200px;\r\n\tmargin: 20px auto;\r\n\tposition: relative;\n}\n.details_audioPro[data-v-d9215584]{\r\n\twidth: 100%;\r\n\theight: 2px;\r\n\tbackground: white;\n}\n.details_audioProUp[data-v-d9215584]{\r\n\twidth: 0;\r\n\theight: 2px;\r\n\tbackground: #29abe2;\r\n\tposition: absolute;\r\n\tleft: 0;\r\n\ttop: 0;\n}\n.details_audioProBar[data-v-d9215584]{\r\n\twidth: 15px;\r\n\theight: 15px;\r\n\tbackground: #29abe2;\r\n\tborder-radius: 50%;\r\n\tposition: absolute;\r\n\ttop: 0;\r\n\tleft: 0;\r\n\tmargin: -7px;\n}\n.details_nowTime[data-v-d9215584]{\r\n\tfont-size: 12px;\r\n\tcolor: #ebdddd;\r\n\tposition: absolute;\r\n\ttop: -8px;\r\n\tleft: -40px;\n}\n.details_allTime[data-v-d9215584]{\r\n\tfont-size: 12px;\r\n\tcolor: #ebdddd;\r\n\tposition: absolute;\r\n\ttop: -8px;\r\n\tright: -40px;\n}\n.details_play[data-v-d9215584]{\r\n\twidth: 55px;\r\n\theight: 55px;\r\n\tposition: absolute;\r\n\tleft: 50%;\r\n\tmargin-left: -27px;\r\n\ttop: 30px;\n}\n.details_play img[data-v-d9215584]{\r\n\twidth: 55px;\r\n\theight: 55px;\n}\n.details_prev[data-v-d9215584]{\r\n\twidth: 37px;\r\n\theight: 37px;\r\n\tbackground: url(http://39.97.167.207/vueimg/details_prev.png) no-repeat;\r\n\tbackground-size: cover;\r\n\tposition: absolute;\r\n\tleft: 10px;\r\n\ttop: 37px;\n}\n.details_next[data-v-d9215584]{\r\n\twidth: 37px;\r\n\theight: 37px;\r\n\tbackground: url(http://39.97.167.207/vueimg/details_next.png) no-repeat;\r\n\tbackground-size: cover;\r\n\tposition: absolute;\r\n\tright: 10px;\r\n\ttop: 37px;\n}\n.shouchang[data-v-d9215584]{\r\n\tposition: absolute;\r\n\tfont-size: 45px;\r\n\tcolor: #29abe2;\r\n\tright: -50px;\r\n\ttop: 34px;\n}\n.pinglun[data-v-d9215584]{\r\n\tposition: absolute;\r\n\tfont-size: 40px;\r\n\tcolor: #29abe2;\r\n\tleft: -50px;\r\n\ttop: 34px;\n}\r\n"]}]);
...
var render = function() {
  ...
  var _h = _vm.$createElement
  var _c = _vm._self._c || _h
  return _vm.onesong.length > 0
    ? _c(
        "div",
        { staticClass: "lrcbox" },
        [
          _c("Heads", { attrs: { title: _vm.onesong[0].musicname } }),
          _vm._v(" "),
          _c(
            "div",
            { staticClass: "details_lyric", attrs: { id: "detailsLyric" } },
            [
              _c(
                "ul",
                { ref: "scrollul", attrs: { id: "detailsLyricUl" } },
                _vm._l(_vm.songlrc, function(word, i) {
                  return _c("li", { key: i, ref: "one", refInFor: true }, [
                    _vm._v(_vm._s(word))
                  ])
                }),
                0
          ...
          _c("div", { staticClass: "details_audio" }, [
            _c("div", { staticClass: "details_audioAll" }, [
              _c("div", { staticClass: "details_audioPro" }, [
                _c("div", { ref: "kuan", staticClass: "details_audioProUp" }),
                _vm._v(" "),
                _c("div", { ref: "lefts", staticClass: "details_audioProBar" })
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "details_nowTime" }, [
                _vm._v(_vm._s(_vm.time.ctime))
              ]),
              _vm._v(" "),
              _c("div", { staticClass: "details_allTime" }, [
                _vm._v(_vm._s(_vm.time.ttime))
              ]),
              _vm._v(" "),
              _c(
                "div",
                { staticClass: "details_play", on: { click: _vm.playaudio } },
                [
                  !_vm.show
                    ? _c("img", {
                        attrs: { src: "images/details_play.png", alt: "" }
                      })
                    : _vm._e(),
                  _vm._v(" "),
                  _vm.show
                    ? _c("img", {
                        attrs: { src: "images/details_pause.png", alt: "" }
                      })
                    : _vm._e()
                ]
              ),
              _vm._v(" "),
              _c("div", {
                staticClass: "details_prev",
                on: {
                  click: function($event) {
                    return _vm.prevSong(_vm.onesong[0].songId)
                  }
                }
              }),
              _vm._v(" "),
              _c("div", {
                staticClass: "details_next",
                on: {
                  click: function($event) {
                    return _vm.nextSong(_vm.onesong[0].songId)
                  }
                }
              }),
              _vm._v(" "),
              _c("i", {
                staticClass: "shouchang iconfont",
                domProps: { innerHTML: _vm._s(_vm.ico) },
                on: {
                  click: function($event) {
                    return _vm.mylove()
              ...
              _vm._v(" "),
              _c("span", {
                staticClass: "pinglun iconfont",
                domProps: { innerHTML: _vm._s(_vm.ico2) },
                on: {
                  click: function($event) {
                    return _vm.pinglun(
                      _vm.onesong[0].name,
                      _vm.onesong[0].musicname,
                      _vm.onesong[0].songId
                    )
                  }
                }
              })
          ...
          _c("audio", {
            ref: "playmusic",
            attrs: {
              src: "images/" + _vm.onesong[0].audio,
              flag: _vm.autop,
              autoplay: ""
            },
            on: {
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-d9215584", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_songlist_vue__ = __webpack_require__(15);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_songlist_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_songlist_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_songlist_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_songlist_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_1d6a7fcd_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_songlist_vue__ = __webpack_require__(50);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
  __webpack_require__(48)
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-1d6a7fcd"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_songlist_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_1d6a7fcd_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_songlist_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/views/songlist.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-1d6a7fcd", Component.options)
  } else {
    hotAPI.reload("data-v-1d6a7fcd", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("1df4aae4", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js?sourceMap!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1d6a7fcd\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/_sass-loader@7.1.0@sass-loader/lib/loader.js!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./songlist.vue", function() {
     var newContent = require("!!../../node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js?sourceMap!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-1d6a7fcd\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/_sass-loader@7.1.0@sass-loader/lib/loader.js!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./songlist.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
exports = module.exports = __webpack_require__(0)(true);
// Module
exports.push([module.i, "\n.order-header[data-v-1d6a7fcd] {\n  width: 100%;\n  height: 200px;\n  background: url(http://39.97.167.207/vueimg/beijing11.jpg) no-repeat;\n  background-size: cover;\n}\n.order-header img[data-v-1d6a7fcd] {\n    height: 75%;\n    width: auto;\n    float: left;\n    margin-top: 25px;\n    margin-left: 25px;\n    border-radius: 50%;\n    animation: 4s linear infinite audioImgMove-data-v-1d6a7fcd;\n}\n.order-header dl[data-v-1d6a7fcd] {\n    float: left;\n    color: #ddd;\n    margin-top: 25px;\n    margin-left: 20px;\n}\n.order-header dl dt[data-v-1d6a7fcd] {\n      margin-top: 10px;\n      font-size: 18px;\n      line-height: 40px;\n}\n.order-header dl dd[data-v-1d6a7fcd] {\n      font-size: 16px;\n      line-height: 30px;\n}\n@keyframes audioImgMove-data-v-1d6a7fcd {\n0% {\n    transform: rotate(0deg);\n}\n100% {\n    transform: rotate(360deg);\n}\n}\n@-webkit-keyframes audioImgMove-data-v-1d6a7fcd {\n0% {\n    -webkit-transform: rotate(0deg);\n}\n100% {\n    -webkit-transform: rotate(360deg);\n}\n}\nul[data-v-1d6a7fcd] {\n  width: 100%;\n}\nul li[data-v-1d6a7fcd] {\n    height: 60px;\n    width: 100%;\n    background-color: rgba(0, 0, 0, 0.1);\n    border-bottom: 3px solid #ddd;\n}\nul li span[data-v-1d6a7fcd] {\n      float: left;\n      width: 20%;\n      height: 60px;\n      line-height: 60px;\n      font-size: 24px;\n      font-weight: 700;\n      text-align: center;\n      color: #888;\n}\nul li h3[data-v-1d6a7fcd] {\n      line-height: 35px;\n      color: #666;\n      float: left;\n      width: 60%;\n}\nul li p[data-v-1d6a7fcd] {\n      font-size: 14px;\n      color: #666;\n      width: 60%;\n      float: left;\n}\nul li i[data-v-1d6a7fcd] {\n      float: left;\n      width: 20%;\n      height: 60px;\n      font-size: 30px;\n      margin-top: -35px;\n      line-height: 60px;\n      text-align: center;\n      color: #777;\n}\n", "",{"version":3,"sources":["songlist.vue"],"names":[],"mappings":";AAAA;EACE,WAAA;EACA,aAAA;EACA,oEAAA;EACA,sBAAA;AAEF;AADE;IACE,WAAA;IACA,WAAA;IACA,WAAA;IACA,gBAAA;IACA,iBAAA;IACA,kBAAA;IACA,0DAAA;AAGJ;AAFE;IACE,WAAA;IACA,WAAA;IACA,gBAAA;IACA,iBAAA;AAIJ;AAHI;MACE,gBAAA;MACA,eAAA;MACA,iBAAA;AAKN;AAJI;MACE,eAAA;MACA,iBAAA;AAMN;AAJA;AACE;IACE,uBAAA;AAMJ;AALE;IACE,yBAAA;AAOJ;AACA;AANA;AACE;IACE,+BAAA;AAQJ;AAPE;IACE,iCAAA;AASJ;AACA;AARA;EACE,WAAA;AAUF;AATE;IACE,YAAA;IACA,WAAA;IACA,oCAAA;IACA,6BAAA;AAWJ;AAVI;MACE,WAAA;MACA,UAAA;MACA,YAAA;MACA,iBAAA;MACA,eAAA;MACA,gBAAA;MACA,kBAAA;MACA,WAAA;AAYN;AAXI;MACE,iBAAA;MACA,WAAA;MACA,WAAA;MACA,UAAA;AAaN;AAZI;MACE,eAAA;MACA,WAAA;MACA,UAAA;MACA,WAAA;AAcN;AAbI;MACE,WAAA;MACA,UAAA;MACA,YAAA;MACA,eAAA;MACA,iBAAA;MACA,iBAAA;MACA,kBAAA;MACA,WAAA;AAeN","file":"songlist.vue","sourcesContent":[".order-header {\n  width: 100%;\n  height: 200px;\n  background: url(http://39.97.167.207/vueimg/beijing11.jpg) no-repeat;\n  background-size: cover; }\n  .order-header img {\n    height: 75%;\n    width: auto;\n    float: left;\n    margin-top: 25px;\n    margin-left: 25px;\n    border-radius: 50%;\n    animation: 4s linear infinite audioImgMove; }\n  .order-header dl {\n    float: left;\n    color: #ddd;\n    margin-top: 25px;\n    margin-left: 20px; }\n    .order-header dl dt {\n      margin-top: 10px;\n      font-size: 18px;\n      line-height: 40px; }\n    .order-header dl dd {\n      font-size: 16px;\n      line-height: 30px; }\n\n@keyframes audioImgMove {\n  0% {\n    transform: rotate(0deg); }\n  100% {\n    transform: rotate(360deg); } }\n\n@-webkit-keyframes audioImgMove {\n  0% {\n    -webkit-transform: rotate(0deg); }\n  100% {\n    -webkit-transform: rotate(360deg); } }\n\nul {\n  width: 100%; }\n  ul li {\n    height: 60px;\n    width: 100%;\n    background-color: rgba(0, 0, 0, 0.1);\n    border-bottom: 3px solid #ddd; }\n    ul li span {\n      float: left;\n      width: 20%;\n      height: 60px;\n      line-height: 60px;\n      font-size: 24px;\n      font-weight: 700;\n      text-align: center;\n      color: #888; }\n    ul li h3 {\n      line-height: 35px;\n      color: #666;\n      float: left;\n      width: 60%; }\n    ul li p {\n      font-size: 14px;\n      color: #666;\n      width: 60%;\n      float: left; }\n    ul li i {\n      float: left;\n      width: 20%;\n      height: 60px;\n      font-size: 30px;\n      margin-top: -35px;\n      line-height: 60px;\n      text-align: center;\n      color: #777; }\n"]}]);
...
var render = function() {
  ...
  return _c(
    ...
    [
      ...
      _c(
        "ul",
        _vm._l(_vm.allsongs, function(song, i) {
          return _c(
            "li",
            {
              key: i,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-1d6a7fcd", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_singer_vue__ = __webpack_require__(16);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_singer_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_singer_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_singer_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_singer_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_5c9ac7d4_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_singer_vue__ = __webpack_require__(54);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-5c9ac7d4"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_singer_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_5c9ac7d4_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_singer_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/views/singer.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-5c9ac7d4", Component.options)
  } else {
    hotAPI.reload("data-v-5c9ac7d4", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("16e832c2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js?sourceMap!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5c9ac7d4\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/_sass-loader@7.1.0@sass-loader/lib/loader.js!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./singer.vue", function() {
     var newContent = require("!!../../node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js?sourceMap!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-5c9ac7d4\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/_sass-loader@7.1.0@sass-loader/lib/loader.js!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./singer.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
exports = module.exports = __webpack_require__(0)(true);
// Module
exports.push([module.i, "\n.order-header[data-v-5c9ac7d4] {\n  width: 100%;\n  height: 200px;\n  background: url(http://39.97.167.207/vueimg/singerbj.jpg) no-repeat;\n  background-size: cover;\n}\n.order-header img[data-v-5c9ac7d4] {\n    height: 75%;\n    width: auto;\n    float: left;\n    margin-top: 25px;\n    margin-left: 25px;\n    border-radius: 50%;\n    animation: 4s linear infinite audioImgMove-data-v-5c9ac7d4;\n}\n.order-header dl[data-v-5c9ac7d4] {\n    float: left;\n    color: #ddd;\n    margin-top: 25px;\n    margin-left: 20px;\n}\n.order-header dl dt[data-v-5c9ac7d4] {\n      margin-top: 10px;\n      font-size: 18px;\n      line-height: 40px;\n}\n.order-header dl dd[data-v-5c9ac7d4] {\n      font-size: 16px;\n      line-height: 30px;\n}\nul[data-v-5c9ac7d4] {\n  width: 100%;\n}\nul li[data-v-5c9ac7d4] {\n    height: 60px;\n    width: 100%;\n    background-color: #eee;\n    border-bottom: 3px solid #ddd;\n}\nul li span[data-v-5c9ac7d4] {\n      float: left;\n      width: 20%;\n      height: 60px;\n      line-height: 60px;\n      font-size: 24px;\n      font-weight: 700;\n      text-align: center;\n      color: #888;\n}\nul li h3[data-v-5c9ac7d4] {\n      line-height: 35px;\n      color: #666;\n      float: left;\n      width: 60%;\n}\nul li p[data-v-5c9ac7d4] {\n      font-size: 14px;\n      color: #666;\n      width: 60%;\n      float: left;\n}\nul li i[data-v-5c9ac7d4] {\n      float: left;\n      width: 20%;\n      height: 60px;\n      font-size: 30px;\n      margin-top: -35px;\n      line-height: 60px;\n      text-align: center;\n      color: #777;\n}\n@keyframes audioImgMove-data-v-5c9ac7d4 {\n0% {\n    transform: rotate(0deg);\n}\n100% {\n    transform: rotate(360deg);\n}\n}\n@-webkit-keyframes audioImgMove-data-v-5c9ac7d4 {\n0% {\n    -webkit-transform: rotate(0deg);\n}\n100% {\n    -webkit-transform: rotate(360deg);\n}\n}\n", "",{"version":3,"sources":["singer.vue"],"names":[],"mappings":";AAAA;EACE,WAAA;EACA,aAAA;EACA,mEAAA;EACA,sBAAA;AAEF;AADE;IACE,WAAA;IACA,WAAA;IACA,WAAA;IACA,gBAAA;IACA,iBAAA;IACA,kBAAA;IACA,0DAAA;AAGJ;AAFE;IACE,WAAA;IACA,WAAA;IACA,gBAAA;IACA,iBAAA;AAIJ;AAHI;MACE,gBAAA;MACA,eAAA;MACA,iBAAA;AAKN;AAJI;MACE,eAAA;MACA,iBAAA;AAMN;AAJA;EACE,WAAA;AAMF;AALE;IACE,YAAA;IACA,WAAA;IACA,sBAAA;IACA,6BAAA;AAOJ;AANI;MACE,WAAA;MACA,UAAA;MACA,YAAA;MACA,iBAAA;MACA,eAAA;MACA,gBAAA;MACA,kBAAA;MACA,WAAA;AAQN;AAPI;MACE,iBAAA;MACA,WAAA;MACA,WAAA;MACA,UAAA;AASN;AARI;MACE,eAAA;MACA,WAAA;MACA,UAAA;MACA,WAAA;AAUN;AATI;MACE,WAAA;MACA,UAAA;MACA,YAAA;MACA,eAAA;MACA,iBAAA;MACA,iBAAA;MACA,kBAAA;MACA,WAAA;AAWN;AATA;AACE;IACE,uBAAA;AAWJ;AAVE;IACE,yBAAA;AAYJ;AACA;AAXA;AACE;IACE,+BAAA;AAaJ;AAZE;IACE,iCAAA;AAcJ;AACA","file":"singer.vue","sourcesContent":[".order-header {\n  width: 100%;\n  height: 200px;\n  background: url(http://39.97.167.207/vueimg/singerbj.jpg) no-repeat;\n  background-size: cover; }\n  .order-header img {\n    height: 75%;\n    width: auto;\n    float: left;\n    margin-top: 25px;\n    margin-left: 25px;\n    border-radius: 50%;\n    animation: 4s linear infinite audioImgMove; }\n  .order-header dl {\n    float: left;\n    color: #ddd;\n    margin-top: 25px;\n    margin-left: 20px; }\n    .order-header dl dt {\n      margin-top: 10px;\n      font-size: 18px;\n      line-height: 40px; }\n    .order-header dl dd {\n      font-size: 16px;\n      line-height: 30px; }\n\nul {\n  width: 100%; }\n  ul li {\n    height: 60px;\n    width: 100%;\n    background-color: #eee;\n    border-bottom: 3px solid #ddd; }\n    ul li span {\n      float: left;\n      width: 20%;\n      height: 60px;\n      line-height: 60px;\n      font-size: 24px;\n      font-weight: 700;\n      text-align: center;\n      color: #888; }\n    ul li h3 {\n      line-height: 35px;\n      color: #666;\n      float: left;\n      width: 60%; }\n    ul li p {\n      font-size: 14px;\n      color: #666;\n      width: 60%;\n      float: left; }\n    ul li i {\n      float: left;\n      width: 20%;\n      height: 60px;\n      font-size: 30px;\n      margin-top: -35px;\n      line-height: 60px;\n      text-align: center;\n      color: #777; }\n\n@keyframes audioImgMove {\n  0% {\n    transform: rotate(0deg); }\n  100% {\n    transform: rotate(360deg); } }\n\n@-webkit-keyframes audioImgMove {\n  0% {\n    -webkit-transform: rotate(0deg); }\n  100% {\n    -webkit-transform: rotate(360deg); } }\n"]}]);
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("Heads", { attrs: { title: _vm.singername } }),
      _vm._v(" "),
      _c("div", { staticClass: "order-header" }, [
        _c("img", { attrs: { src: _vm.imgs, alt: "" } }),
        _vm._v(" "),
      ...
      _c(
        "ul",
        _vm._l(_vm.singersong, function(song, i) {
          return _c(
            "li",
            {
              key: i,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-5c9ac7d4", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_singtype_vue__ = __webpack_require__(17);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_singtype_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_singtype_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_singtype_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_singtype_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_27897fe3_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_singtype_vue__ = __webpack_require__(58);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-27897fe3"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_singtype_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_27897fe3_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_singtype_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/views/singtype.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-27897fe3", Component.options)
  } else {
    hotAPI.reload("data-v-27897fe3", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("9cc62e4e", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js?sourceMap!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-27897fe3\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/_sass-loader@7.1.0@sass-loader/lib/loader.js!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./singtype.vue", function() {
     var newContent = require("!!../../node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js?sourceMap!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-27897fe3\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/_sass-loader@7.1.0@sass-loader/lib/loader.js!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./singtype.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
exports = module.exports = __webpack_require__(0)(true);
// Module
exports.push([module.i, "\n.order-header[data-v-27897fe3] {\n  width: 100%;\n  height: 200px;\n  background-color: rgba(0, 0, 0, 0.9);\n}\n.order-header img[data-v-27897fe3] {\n    height: 75%;\n    width: auto;\n    float: left;\n    margin-top: 25px;\n    margin-left: 25px;\n}\n.order-header dl[data-v-27897fe3] {\n    float: left;\n    color: #ddd;\n    margin-top: 25px;\n    margin-left: 20px;\n}\n.order-header dl dt[data-v-27897fe3] {\n      margin-top: 10px;\n      font-size: 18px;\n      line-height: 40px;\n}\n.order-header dl dd[data-v-27897fe3] {\n      font-size: 16px;\n      line-height: 30px;\n}\nul[data-v-27897fe3] {\n  width: 100%;\n}\nul li[data-v-27897fe3] {\n    height: 60px;\n    width: 100%;\n    background-color: #eee;\n    border-bottom: 3px solid #ddd;\n}\nul li span[data-v-27897fe3] {\n      float: left;\n      width: 20%;\n      height: 60px;\n      line-height: 60px;\n      font-size: 24px;\n      font-weight: 700;\n      text-align: center;\n      color: #888;\n}\nul li h3[data-v-27897fe3] {\n      line-height: 35px;\n      color: #666;\n      float: left;\n      width: 60%;\n}\nul li p[data-v-27897fe3] {\n      font-size: 14px;\n      color: #666;\n      width: 60%;\n      float: left;\n}\nul li i[data-v-27897fe3] {\n      float: left;\n      width: 20%;\n      height: 60px;\n      font-size: 30px;\n      margin-top: -35px;\n      line-height: 60px;\n      text-align: center;\n      color: #777;\n}\n", "",{"version":3,"sources":["singtype.vue"],"names":[],"mappings":";AAAA;EACE,WAAA;EACA,aAAA;EACA,oCAAA;AAEF;AADE;IACE,WAAA;IACA,WAAA;IACA,WAAA;IACA,gBAAA;IACA,iBAAA;AAGJ;AAFE;IACE,WAAA;IACA,WAAA;IACA,gBAAA;IACA,iBAAA;AAIJ;AAHI;MACE,gBAAA;MACA,eAAA;MACA,iBAAA;AAKN;AAJI;MACE,eAAA;MACA,iBAAA;AAMN;AAJA;EACE,WAAA;AAMF;AALE;IACE,YAAA;IACA,WAAA;IACA,sBAAA;IACA,6BAAA;AAOJ;AANI;MACE,WAAA;MACA,UAAA;MACA,YAAA;MACA,iBAAA;MACA,eAAA;MACA,gBAAA;MACA,kBAAA;MACA,WAAA;AAQN;AAPI;MACE,iBAAA;MACA,WAAA;MACA,WAAA;MACA,UAAA;AASN;AARI;MACE,eAAA;MACA,WAAA;MACA,UAAA;MACA,WAAA;AAUN;AATI;MACE,WAAA;MACA,UAAA;MACA,YAAA;MACA,eAAA;MACA,iBAAA;MACA,iBAAA;MACA,kBAAA;MACA,WAAA;AAWN","file":"singtype.vue","sourcesContent":[".order-header {\n  width: 100%;\n  height: 200px;\n  background-color: rgba(0, 0, 0, 0.9); }\n  .order-header img {\n    height: 75%;\n    width: auto;\n    float: left;\n    margin-top: 25px;\n    margin-left: 25px; }\n  .order-header dl {\n    float: left;\n    color: #ddd;\n    margin-top: 25px;\n    margin-left: 20px; }\n    .order-header dl dt {\n      margin-top: 10px;\n      font-size: 18px;\n      line-height: 40px; }\n    .order-header dl dd {\n      font-size: 16px;\n      line-height: 30px; }\n\nul {\n  width: 100%; }\n  ul li {\n    height: 60px;\n    width: 100%;\n    background-color: #eee;\n    border-bottom: 3px solid #ddd; }\n    ul li span {\n      float: left;\n      width: 20%;\n      height: 60px;\n      line-height: 60px;\n      font-size: 24px;\n      font-weight: 700;\n      text-align: center;\n      color: #888; }\n    ul li h3 {\n      line-height: 35px;\n      color: #666;\n      float: left;\n      width: 60%; }\n    ul li p {\n      font-size: 14px;\n      color: #666;\n      width: 60%;\n      float: left; }\n    ul li i {\n      float: left;\n      width: 20%;\n      height: 60px;\n      font-size: 30px;\n      margin-top: -35px;\n      line-height: 60px;\n      text-align: center;\n      color: #777; }\n"]}]);
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("Heads", { attrs: { title: _vm.itype } }),
      _vm._v(" "),
      _c("div", { staticClass: "order-header" }, [
        _c("img", { attrs: { src: _vm.isrc, alt: "" } }),
        _vm._v(" "),
        _vm._m(0)
      ]),
      _vm._v(" "),
      _c(
        "ul",
        _vm._l(_vm.songlist, function(song, i) {
          return _c(
            "li",
            {
              key: i,
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-27897fe3", esExports)
  }
}
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_login_vue__ = __webpack_require__(18);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_7589b93f_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_login_vue__ = __webpack_require__(65);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_7589b93f_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_login_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("38605b36", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js?sourceMap!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-7589b93f\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/_sass-loader@7.1.0@sass-loader/lib/loader.js!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./login.vue", function() {
...
exports = module.exports = __webpack_require__(0)(true);
// Module
exports.push([module.i, "\n.loginbox[data-v-7589b93f] {\n  width: 100%;\n  height: 100%;\n  text-align: center;\n}\n.loginbox .logintop[data-v-7589b93f] {\n    width: 100%;\n    height: 300px;\n    background: url(http://39.97.167.207/vueimg/reg.gif) no-repeat;\n    background-size: cover;\n    text-align: center;\n}\n.loginbox .logintop input[data-v-7589b93f] {\n      width: 70%;\n      height: 40px;\n      border-radius: 5px;\n      border: none;\n      margin-top: 20px;\n      text-indent: 1em;\n      background-color: rgba(245, 245, 245, 0.5) !important;\n      color: #eee;\n}\n.loginbox .logintop[data-v-7589b93f] ::-webkit-input-placeholder {\n      text-indent: 1em;\n      color: #eee;\n}\n.loginbox .logintop .firstinp[data-v-7589b93f] {\n      margin-top: 150px;\n}\n.loginbox .toreg[data-v-7589b93f] {\n    margin-top: 50px;\n    color: #26a2ff;\n}\n.loginbox .btn[data-v-7589b93f] {\n    width: 70%;\n    height: 40px;\n    border-radius: 5px;\n    background-color: #26a2ff;\n    border: none;\n    margin-top: 50px;\n    color: #eee;\n    font-size: 20px;\n}\n.loginbox .loginbut[data-v-7589b93f] {\n    height: 50px;\n    line-height: 50px;\n    margin-top: 10px;\n    border-top: 1px solid #ddd;\n    color: #888;\n}\n", "",{"version":3,"sources":["login.vue"],"names":[],"mappings":";AAAA;EACE,WAAA;EACA,YAAA;EACA,kBAAA;AAEF;AADE;IACE,WAAA;IACA,aAAA;IACA,8DAAA;IACA,sBAAA;IACA,kBAAA;AAGJ;AAFI;MACE,UAAA;MACA,YAAA;MACA,kBAAA;MACA,YAAA;MACA,gBAAA;MACA,gBAAA;MACA,qDAAA;MACA,WAAA;AAIN;AAHI;MACE,gBAAA;MACA,WAAA;AAKN;AAJI;MACE,iBAAA;AAMN;AALE;IACE,gBAAA;IACA,cAAA;AAOJ;AANE;IACE,UAAA;IACA,YAAA;IACA,kBAAA;IACA,yBAAA;IACA,YAAA;IACA,gBAAA;IACA,WAAA;IACA,eAAA;AAQJ;AAPE;IACE,YAAA;IACA,iBAAA;IACA,gBAAA;IACA,0BAAA;IACA,WAAA;AASJ","file":"login.vue","sourcesContent":[".loginbox {\n  width: 100%;\n  height: 100%;\n  text-align: center; }\n  .loginbox .logintop {\n    width: 100%;\n    height: 300px;\n    background: url(http://39.97.167.207/vueimg/reg.gif) no-repeat;\n    background-size: cover;\n    text-align: center; }\n    .loginbox .logintop input {\n      width: 70%;\n      height: 40px;\n      border-radius: 5px;\n      border: none;\n      margin-top: 20px;\n      text-indent: 1em;\n      background-color: rgba(245, 245, 245, 0.5) !important;\n      color: #eee; }\n    .loginbox .logintop ::-webkit-input-placeholder {\n      text-indent: 1em;\n      color: #eee; }\n    .loginbox .logintop .firstinp {\n      margin-top: 150px; }\n  .loginbox .toreg {\n    margin-top: 50px;\n    color: #26a2ff; }\n  .loginbox .btn {\n    width: 70%;\n    height: 40px;\n    border-radius: 5px;\n    background-color: #26a2ff;\n    border: none;\n    margin-top: 50px;\n    color: #eee;\n    font-size: 20px; }\n  .loginbox .loginbut {\n    height: 50px;\n    line-height: 50px;\n    margin-top: 10px;\n    border-top: 1px solid #ddd;\n    color: #888; }\n"]}]);
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("Heads", { attrs: { title: "用户登录" } }),
      _vm._v(" "),
      _c("div", { staticClass: "loginbox" }, [
        _c("div", { staticClass: "logintop" }, [
          _c("input", {
            ref: "username",
            staticClass: "firstinp",
            attrs: { type: "text", placeholder: "用户手机号码" }
          }),
          _vm._v(" "),
          _c("input", {
            ref: "userpwd",
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_register_vue__ = __webpack_require__(19);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_77453986_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_register_vue__ = __webpack_require__(69);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-77453986"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_77453986_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_register_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("7b70ca57", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js?sourceMap!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-77453986\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/_sass-loader@7.1.0@sass-loader/lib/loader.js!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./register.vue", function() {
     var newContent = require("!!../../node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js?sourceMap!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-77453986\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/_sass-loader@7.1.0@sass-loader/lib/loader.js!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./register.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
...
exports = module.exports = __webpack_require__(0)(true);
// Module
exports.push([module.i, "\n.loginbox[data-v-77453986] {\n  width: 100%;\n  height: 100%;\n  text-align: center;\n}\n.loginbox .logintop[data-v-77453986] {\n    width: 100%;\n    height: 330px;\n    background: url(http://39.97.167.207/vueimg/loginbj.jpg) no-repeat;\n    background-size: cover;\n    text-align: center;\n}\n.loginbox .logintop input[data-v-77453986] {\n      width: 70%;\n      height: 40px;\n      border-radius: 5px;\n      border: none;\n      margin-top: 20px;\n      text-indent: 1em;\n      background-color: rgba(245, 245, 245, 0.5);\n      color: #eee;\n}\n.loginbox .logintop[data-v-77453986] ::-webkit-input-placeholder {\n      text-indent: 1em;\n      color: #eee;\n}\n.loginbox .logintop .firstinp[data-v-77453986] {\n      margin-top: 60px;\n}\n.loginbox .btn[data-v-77453986] {\n    width: 70%;\n    height: 40px;\n    border-radius: 5px;\n    background-color: #26a2ff;\n    border: none;\n    margin-top: 50px;\n    color: #eee;\n    font-size: 20px;\n}\n.loginbox .loginbut[data-v-77453986] {\n    height: 50px;\n    line-height: 50px;\n    margin-top: 30px;\n    border-top: 1px solid #ddd;\n    color: #888;\n}\n", "",{"version":3,"sources":["register.vue"],"names":[],"mappings":";AAAA;EACE,WAAA;EACA,YAAA;EACA,kBAAA;AAEF;AADE;IACE,WAAA;IACA,aAAA;IACA,kEAAA;IACA,sBAAA;IACA,kBAAA;AAGJ;AAFI;MACE,UAAA;MACA,YAAA;MACA,kBAAA;MACA,YAAA;MACA,gBAAA;MACA,gBAAA;MACA,0CAAA;MACA,WAAA;AAIN;AAHI;MACE,gBAAA;MACA,WAAA;AAKN;AAJI;MACE,gBAAA;AAMN;AALE;IACE,UAAA;IACA,YAAA;IACA,kBAAA;IACA,yBAAA;IACA,YAAA;IACA,gBAAA;IACA,WAAA;IACA,eAAA;AAOJ;AANE;IACE,YAAA;IACA,iBAAA;IACA,gBAAA;IACA,0BAAA;IACA,WAAA;AAQJ","file":"register.vue","sourcesContent":[".loginbox {\n  width: 100%;\n  height: 100%;\n  text-align: center; }\n  .loginbox .logintop {\n    width: 100%;\n    height: 330px;\n    background: url(http://39.97.167.207/vueimg/loginbj.jpg) no-repeat;\n    background-size: cover;\n    text-align: center; }\n    .loginbox .logintop input {\n      width: 70%;\n      height: 40px;\n      border-radius: 5px;\n      border: none;\n      margin-top: 20px;\n      text-indent: 1em;\n      background-color: rgba(245, 245, 245, 0.5);\n      color: #eee; }\n    .loginbox .logintop ::-webkit-input-placeholder {\n      text-indent: 1em;\n      color: #eee; }\n    .loginbox .logintop .firstinp {\n      margin-top: 60px; }\n  .loginbox .btn {\n    width: 70%;\n    height: 40px;\n    border-radius: 5px;\n    background-color: #26a2ff;\n    border: none;\n    margin-top: 50px;\n    color: #eee;\n    font-size: 20px; }\n  .loginbox .loginbut {\n    height: 50px;\n    line-height: 50px;\n    margin-top: 30px;\n    border-top: 1px solid #ddd;\n    color: #888; }\n"]}]);
    ...
    [
      ...
      _c("div", { staticClass: "loginbox" }, [
        _c("div", { staticClass: "logintop" }, [
          ...
          _c("input", {
            ref: "nikename",
            attrs: { type: "text", placeholder: "用户昵称" }
          }),
          _vm._v(" "),
          _c("input", {
            ref: "pwd1",
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_opinion_vue__ = __webpack_require__(20);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_opinion_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_opinion_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_opinion_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_opinion_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_fa7c5d50_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_opinion_vue__ = __webpack_require__(73);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-fa7c5d50"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_opinion_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_fa7c5d50_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_opinion_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/views/opinion.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-fa7c5d50", Component.options)
  } else {
    hotAPI.reload("data-v-fa7c5d50", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("47f78def", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js?sourceMap!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-fa7c5d50\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/_sass-loader@7.1.0@sass-loader/lib/loader.js!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./opinion.vue", function() {
     var newContent = require("!!../../node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js?sourceMap!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-fa7c5d50\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/_sass-loader@7.1.0@sass-loader/lib/loader.js!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./opinion.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
 }
...
exports = module.exports = __webpack_require__(0)(true);
// Module
exports.push([module.i, "\n.songmsg[data-v-fa7c5d50] {\n  width: 100%;\n  height: 50px;\n  line-height: 50px;\n  border-bottom: 1px solid #ddd;\n  text-indent: 1em;\n  color: #777;\n}\n.songmsg img[data-v-fa7c5d50] {\n    margin-top: 5px;\n    height: 40px;\n    float: left;\n    margin-left: 15px;\n    border-radius: 50%;\n}\n.songmsg span[data-v-fa7c5d50] {\n    float: left;\n}\n.songmsg .backs[data-v-fa7c5d50] {\n    float: right;\n    margin-right: 15px;\n    color: #26a2ff;\n    font-size: 20px;\n}\n.plqu[data-v-fa7c5d50] {\n  width: 100%;\n  border-bottom: 1px solid #eee;\n  margin-top: 10px;\n}\n.plqu h3[data-v-fa7c5d50] {\n    height: 35px;\n    line-height: 35px;\n    color: darkblue;\n    text-indent: 1em;\n}\n.plqu .pmsg[data-v-fa7c5d50] {\n    width: 80%;\n    line-height: 30px;\n    margin-left: 15%;\n    color: #666;\n}\n.plqu .timer[data-v-fa7c5d50] {\n    height: 30px;\n    line-height: 30px;\n    color: #888;\n    font-size: 14px;\n    text-align: right;\n    padding-right: 10%;\n}\n.setopin[data-v-fa7c5d50] {\n  width: 100%;\n  height: 50px;\n  border-top: 1px solid #ddd;\n  position: fixed;\n  left: 0;\n  bottom: 0;\n  line-height: 50px;\n}\n.setopin input[data-v-fa7c5d50] {\n    float: left;\n    width: 70%;\n    height: 40px;\n    outline: none;\n    border: 1px solid #ddd;\n    border-radius: 20px;\n    text-indent: 1em;\n    color: #666;\n    background-color: #eee;\n    margin-top: 5px;\n    margin-left: 10px;\n}\n.setopin[data-v-fa7c5d50] ::-webkit-input-placeholder {\n    text-indent: 1em;\n    color: #666;\n}\n.setopin span[data-v-fa7c5d50] {\n    float: right;\n    height: 40px;\n    line-height: 40px;\n    text-align: center;\n    border-radius: 20px;\n    margin-top: 5px;\n    margin-right: 10px;\n    width: 20%;\n    color: #eee;\n    background-color: #26a2ff;\n}\n", "",{"version":3,"sources":["opinion.vue"],"names":[],"mappings":";AAAA;EACE,WAAA;EACA,YAAA;EACA,iBAAA;EACA,6BAAA;EACA,gBAAA;EACA,WAAA;AAEF;AADE;IACE,eAAA;IACA,YAAA;IACA,WAAA;IACA,iBAAA;IACA,kBAAA;AAGJ;AAFE;IACE,WAAA;AAIJ;AAHE;IACE,YAAA;IACA,kBAAA;IACA,cAAA;IACA,eAAA;AAKJ;AAHA;EACE,WAAA;EACA,6BAAA;EACA,gBAAA;AAKF;AAJE;IACE,YAAA;IACA,iBAAA;IACA,eAAA;IACA,gBAAA;AAMJ;AALE;IACE,UAAA;IACA,iBAAA;IACA,gBAAA;IACA,WAAA;AAOJ;AANE;IACE,YAAA;IACA,iBAAA;IACA,WAAA;IACA,eAAA;IACA,iBAAA;IACA,kBAAA;AAQJ;AANA;EACE,WAAA;EACA,YAAA;EACA,0BAAA;EACA,eAAA;EACA,OAAA;EACA,SAAA;EACA,iBAAA;AAQF;AAPE;IACE,WAAA;IACA,UAAA;IACA,YAAA;IACA,aAAA;IACA,sBAAA;IACA,mBAAA;IACA,gBAAA;IACA,WAAA;IACA,sBAAA;IACA,eAAA;IACA,iBAAA;AASJ;AARE;IACE,gBAAA;IACA,WAAA;AAUJ;AATE;IACE,YAAA;IACA,YAAA;IACA,iBAAA;IACA,kBAAA;IACA,mBAAA;IACA,eAAA;IACA,kBAAA;IACA,UAAA;IACA,WAAA;IACA,yBAAA;AAWJ","file":"opinion.vue","sourcesContent":[".songmsg {\n  width: 100%;\n  height: 50px;\n  line-height: 50px;\n  border-bottom: 1px solid #ddd;\n  text-indent: 1em;\n  color: #777; }\n  .songmsg img {\n    margin-top: 5px;\n    height: 40px;\n    float: left;\n    margin-left: 15px;\n    border-radius: 50%; }\n  .songmsg span {\n    float: left; }\n  .songmsg .backs {\n    float: right;\n    margin-right: 15px;\n    color: #26a2ff;\n    font-size: 20px; }\n\n.plqu {\n  width: 100%;\n  border-bottom: 1px solid #eee;\n  margin-top: 10px; }\n  .plqu h3 {\n    height: 35px;\n    line-height: 35px;\n    color: darkblue;\n    text-indent: 1em; }\n  .plqu .pmsg {\n    width: 80%;\n    line-height: 30px;\n    margin-left: 15%;\n    color: #666; }\n  .plqu .timer {\n    height: 30px;\n    line-height: 30px;\n    color: #888;\n    font-size: 14px;\n    text-align: right;\n    padding-right: 10%; }\n\n.setopin {\n  width: 100%;\n  height: 50px;\n  border-top: 1px solid #ddd;\n  position: fixed;\n  left: 0;\n  bottom: 0;\n  line-height: 50px; }\n  .setopin input {\n    float: left;\n    width: 70%;\n    height: 40px;\n    outline: none;\n    border: 1px solid #ddd;\n    border-radius: 20px;\n    text-indent: 1em;\n    color: #666;\n    background-color: #eee;\n    margin-top: 5px;\n    margin-left: 10px; }\n  .setopin ::-webkit-input-placeholder {\n    text-indent: 1em;\n    color: #666; }\n  .setopin span {\n    float: right;\n    height: 40px;\n    line-height: 40px;\n    text-align: center;\n    border-radius: 20px;\n    margin-top: 5px;\n    margin-right: 10px;\n    width: 20%;\n    color: #eee;\n    background-color: #26a2ff; }\n"]}]);
...
var render = function() {
  ...
  return _c(
    "div",
    [
      _c("Heads", { attrs: { title: "歌曲评论" } }),
      _vm._v(" "),
      _c("div", { staticClass: "songmsg" }, [
        _c("img", { attrs: { src: _vm.pic1, alt: "" } }),
        _vm._v(" "),
        _c("span", [_vm._v(_vm._s(_vm.name) + " - " + _vm._s(_vm.song))]),
        _vm._v(" "),
        _c(
          "span",
          {
      ...
      _vm._v(" "),
      _vm._l(_vm.songpl, function(onepl, i) {
        return _c("div", { key: i, staticClass: "plqu" }, [
          _c("h3", [_vm._v(_vm._s(onepl.user))]),
          _vm._v(" "),
          _c("p", { staticClass: "pmsg" }, [_vm._v(_vm._s(onepl.content))]),
          _vm._v(" "),
          _c("p", { staticClass: "timer" }, [_vm._v(_vm._s(onepl.timer))])
        ])
      }),
      _vm._v(" "),
      _c("div", { staticClass: "setopin" }, [
        _c("input", {
          ref: "txtinp",
          attrs: { type: "text", placeholder: "文明评论" }
        }),
        _vm._v(" "),
        _c(
          "span",
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-fa7c5d50", esExports)
  }
}
...
exports.default = new _vuex2.default.Store({
    ...
    getters: {
        ...
        songlist: function songlist(state) {
            return state.allsongs.filter(function (item, index) {
                return item.musictype == state.songtype;
            });
        },
        singersong: function singersong(state) {
            return state.allsongs.filter(function (item, index) {
                return item.name == state.onesinger;
            });
        },
        onesong: function onesong(state) {
            return state.allsongs.filter(function (item, index) {
                return item.songId == state.getSong;
            });
        }
    },
    actions: {
        getAllsongs: function getAllsongs(_ref, _ref2) {
            var commit = _ref.commit;
            var url = _ref2.url;

            _vue2.default.http.get(url).then(function (res) {
                commit("getAllsongs", res.data.result);
            });
        },
        getsongtype: function getsongtype(_ref3, result) {
            var commit = _ref3.commit;

            commit('songtype', result);
        },
        getsingerm: function getsingerm(_ref4, singer) {
            var commit = _ref4.commit;

            commit('singerm', singer);
        },
        getPl: function getPl(_ref5, _ref6) {
            var commit = _ref5.commit;
            var url = _ref6.url;

            _vue2.default.http.get(url).then(function (res) {
                commit("getPl", res.data.result);
            });
        },
        getSong: function getSong(_ref7, songId) {
            var commit = _ref7.commit;

            commit('getSong', songId);
        }
    },
    mutations: {
        getAllsongs: function getAllsongs(state, songs) {
            state.allsongs = songs;
        },
        songtype: function songtype(state, result) {
            state.songtype = result;
        },
        singerm: function singerm(state, singer) {
            state.onesinger = singer;
        },
        getPl: function getPl(state, plist) {
            state.plList = plist;
        },
        getSong: function getSong(state, songId) {
            state.getSong = songId;
        }
    }
});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_heads_vue__ = __webpack_require__(21);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_heads_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_heads_vue__);
/* harmony namespace reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_heads_vue__) if(__WEBPACK_IMPORT_KEY__ !== 'default') (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_heads_vue__[key]; }) }(__WEBPACK_IMPORT_KEY__));
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_6b553933_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_heads_vue__ = __webpack_require__(81);
var disposed = false
function injectStyle (ssrContext) {
  if (disposed) return
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-6b553933"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  __WEBPACK_IMPORTED_MODULE_0__babel_loader_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_script_index_0_heads_vue___default.a,
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_13_7_3_vue_loader_lib_template_compiler_index_id_data_v_6b553933_hasScoped_true_buble_transforms_node_modules_vue_loader_13_7_3_vue_loader_lib_selector_type_template_index_0_heads_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
)
Component.options.__file = "src/components/heads.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-6b553933", Component.options)
  } else {
    hotAPI.reload("data-v-6b553933", Component.options)
  }
  module.hot.dispose(function (data) {
    disposed = true
  })
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(1)("31bd73f2", content, false, {});
// Hot Module Replacement
if(false) {
 // When the styles change, update the <style> tags
 if(!content.locals) {
   module.hot.accept("!!../../node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js?sourceMap!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-6b553933\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/_sass-loader@7.1.0@sass-loader/lib/loader.js!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./heads.vue", function() {
     var newContent = require("!!../../node_modules/_css-loader@2.1.1@css-loader/dist/cjs.js?sourceMap!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/style-compiler/index.js?{\"vue\":true,\"id\":\"data-v-6b553933\",\"scoped\":true,\"hasInlineConfig\":true}!../../node_modules/_sass-loader@7.1.0@sass-loader/lib/loader.js!../../node_modules/_vue-loader@13.7.3@vue-loader/lib/selector.js?type=styles&index=0!./heads.vue");
     if(typeof newContent === 'string') newContent = [[module.id, newContent, '']];
     update(newContent);
   });
...
exports = module.exports = __webpack_require__(0)(true);
// Module
exports.push([module.i, "\n.free[data-v-6b553933] {\n  width: 100%;\n  height: 40px;\n}\n", "",{"version":3,"sources":["heads.vue"],"names":[],"mappings":";AAAA;EACE,WAAA;EACA,YAAA;AAEF","file":"heads.vue","sourcesContent":[".free {\n  width: 100%;\n  height: 40px; }\n"]}]);
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
    require("vue-loader/node_modules/vue-hot-reload-api")      .rerender("data-v-6b553933", esExports)
  }
}

/***/ })
/******/ ]);
//# sourceMappingURL=main.f8fe993b.js.map